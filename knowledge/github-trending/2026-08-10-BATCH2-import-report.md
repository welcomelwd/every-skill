...
| `sickn33/agentic-awesome-skills` | up-to-date | `skill/development/agentic-awesome-skills @ 77a348f816d822b16f6ee9c3d72445ec92f70699` |
| `shanraisshan/claude-code-best-practice` | up-to-date | `skill/development/claude-code-best-practice @ 8020188c61a4081399a6ae5aed662024d872d1ac` |
| `FlorianBruniaux/claude-code-ultimate-guide` | updated | `skill/development/claude-code-ultimate-guide @ bea6bf629c5ab01d1bd0e56f5546359332a59106 (1049 files, 15573118 bytes); excluded 10 files` |
| `alirezarezvani/claude-skills` | up-to-date | `skill/development/claude-skills @ aa8d778811a557a2c28ccadda4cf3d0bd028a4cc` |
| `f/prompts.chat` | up-to-date | `skill/development/prompts-chat @ f1c515686725fcd84a90d361b9eeb11eb15edb17` |
...
| `n8n-io/n8n` | up-to-date | `mcp/servers/n8n @ b186fa87c1b5bb9ffd6562d305ebc611a53e1cce` |
...
| `maximhq/bifrost` | up-to-date | `mcp/tools/bifrost @ f270f9039a258f36263085ca133178c97a61897f` |
...
| `modelcontextprotocol/go-sdk` | up-to-date | `mcp/clients/modelcontextprotocol-go-sdk @ 64e454e35c23c473e1fcf1e1c3a6f623260ca773` |
