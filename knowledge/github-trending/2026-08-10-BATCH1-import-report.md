...
| 项目 | 状态 | 目录或原因 |
| --- | --- | --- |
| `affaan-m/ECC` | updated | `skill/development/ecc @ 50743cec75852e32d6517c9894a3339a2462a713 (3440 files, 25384599 bytes); excluded 48 files` |
...
| `hesreallyhim/awesome-claude-code` | updated | `skill/development/awesome-claude-code @ d95c1126a7a28823fe773562558ebcaa679ec03d (55 files, 1241944 bytes); excluded 1 files` |
...
| `ChromeDevTools/chrome-devtools-mcp` | updated | `mcp/servers/chrome-devtools-mcp @ fce756ad199af2ee0ebdab08d568b14c137b8142 (282 files, 6002088 bytes); excluded 5 files` |
...
| `oraios/serena` | up-to-date | `mcp/tools/serena @ 93ec043105f5ee4f5ff64ea0158041500d2cdc65` |
...
| `browser-use/browser-use` | up-to-date | `agent/workflows/browser-use @ f3298c559aabb327a61cf6a9caef5ea3462f45de` |
| `NousResearch/hermes-agent` | updated | `agent/workflows/hermes-agent @ be38224b49f015cc8dc1d7ae4762be85d19ea97a (2810 files, 26214390 bytes); excluded 6584 files` |
...
| `google-gemini/gemini-cli` | up-to-date | `agent/runtimes/gemini-cli @ 2a87e7be103308b8734246097ba723cc7deb4122` |
| `ComposioHQ/composio` | up-to-date | `agent/runtimes/composio @ b297a6ed5eb15c1507e3fa052f3156fd0c3acc2c` |
| `Aider-AI/aider` | up-to-date | `agent/runtimes/aider @ 5dc9490bb35f9729ef2c95d00a19ccd30c26339c` |
| `code-yeongyu/oh-my-openagent` | updated | `agent/runtimes/oh-my-openagent @ 4751bb1ee54aefd29b3166e58a36b7090d6fcb04 (2836 files, 26214397 bytes); excluded 5216 files` |
| `infiniflow/ragflow` | updated | `knowledge/rag/ragflow @ c6ba54bc7236dcbf463a9e94072103cb8d64f7d8 (2264 files, 26214395 bytes); excluded 3248 files` |
| `run-llama/llama_index` | up-to-date | `knowledge/rag/llama-index @ afd0fef371831f9bda13e5af7167cf4e981278ab` |
| `deepset-ai/haystack` | updated | `knowledge/rag/haystack @ 915888bbc712d33459baa9baf6f830178ab54008 (1957 files, 26214392 bytes); excluded 8119 files` |
| `HKUDS/LightRAG` | updated | `knowledge/rag/lightrag @ 4ba80741347c3a35322d7fc452919dbc51e5f2cf (986 files, 18953948 bytes); excluded 35 files` |
| `VectifyAI/PageIndex` | up-to-date | `knowledge/rag/pageindex @ 08a912c69ce7d3f39541df7f360648f94ce6e234` |
| `vllm-project/vllm` | updated | `knowledge/tools/vllm @ 84530eb235dc3d866fa7d4588217f2fb53f43e76 (2793 files, 26214390 bytes); excluded 3790 files` |
| `ggml-org/llama.cpp` | updated | `knowledge/tools/llama-cpp @ 10bf611e533d81f739128304991c5e133c6aebd8 (1597 files, 26214400 bytes); excluded 1828 files` |
| `langfuse/langfuse` | up-to-date | `knowledge/evaluations/langfuse @ ab58010c81339ffb3e19fc491d71733cf4f10f6a` |
