...
فذخيرة تدريب النموذج تكاد تكون كلها تناوبية: يتبع السؤالَ جواب، ويتبع استدعاءَ الأداة نتيجتُها، ولا يفتح أحدهما فمه حتى يفرغ الآخر. ولذلك تفترض السياسة التي تعلّمها النموذج أن العالم سينتظره. لكن البيئة الحقيقية لا تنتظر: يصل بريد وهو يفكّر، ويقاطعه المستخدم في منتصف الجملة، وتكون الصفحة قد تغيّرت بين لقطتَي شاشة، ويُقلب الكوب والذراع في طريقها إليه. **وأقسام هذا الفصل الأربعة هي هذا الافتراض يُرخى واحدًا واحدًا على أربعة مقاييس زمنية.**

ولننظر أولًا في مواضعها:
...
عندما ينتقل النظام التسلسلي من التنفيذ المتتابع إلى البث، فإن الأهم ليس تحويل كل دالة إلى `async`، بل السماح **للنتائج التزايدية بأن تصبح غير صالحة وأن تُلغى**.
...
إذا كان المطلوب فقط تحديد ما إذا كان المستخدم قد أنهى كلامه، فيمكن دمج قرار نهاية الدور مباشرة في أداة التعرف المتدفقة. ويجب ألا تستخدم تسميات التدريب إلا المعلومات المتاحة لحظة اتخاذ القرار؛ وإلا أنتجت معرفة ما بعد الحدث حكماً لا يمكن تكراره على الإنترنت[^ch6-11]. وهذا مسار أخف من نموذج لغوي صوتي كامل.

[^ch6-11]: لتشخيص دمج قرار الدور في المتعرّف ومشكلة الملصقات التي تستخدم معلومات لاحقة، انظر Bojie Li وNoah Shi، *The Trade-off Was in the Labels: Causal Supervision for Turn-Aware Streaming ASR*، 2026 (قيد النشر).
...
حتى مع الإدراك المتدفق، تمرر السلسلة السماع والتفكير والكلام عبر واجهات منفصلة، وقد تضيع العاطفة والتنغيم والصوت المحيط عند تحويل الصوت إلى نص. يستمع Omni ويولد الرد وينطقه بنموذج واحد، مع كلفة تدريب وتصحيح واستبدال أعلى (الشكل 6-9). ميزته الأساسية هي زمن الاستجابة وحفظ المعلومات غير النصية، لا دقة أعلى بالضرورة: قد تصحح السلسلة الذاتية خطأً إدراكيًا عندما يكفي النص، لكنها تفقد الدليل نهائيًا إذا اعتمدت الإجابة على سرعة الكلام أو عاطفته أو البيئة[^ch6-13].
...
[^ch6-13]: لقياس متى تنعكس أفضلية الدقة بين السلسلة والطرف إلى الطرف، انظر Li, Bojie وNoah Shi، *The Cascade Gap: When and Why Self-Cascades Help Multimodal Agents*، 2026 (قيد النشر).
...
#### الحل الثالث: توحيد التفكير والتعبير من طرف إلى طرف (بمثال Step-Audio R1)
...
في الحالة المثلى، ينبغي أن يستدل النموذج على الانفعال من طبقة الصوت وإيقاعه ونبرته، لا من النص المفرّغ وحده. وما يسمّى "التفكير بالوكالة عن النص" هو أن يستبدل النموذج بتحليل اللحن والسمات الصوتية كلماتٍ سلبية في كلمات الأغنية. وتنقّي MGRD مسارات التفكير التي تستشهد فعلًا بالسمات الصوتية، ثم تدرّب النموذج على هذه البيانات، وتمنع بالتعلم المعزز أن يقفز النموذج فوق التفكير ليخمّن الجواب مباشرةً.

وتجعل MPS دماغ التصوّر ينتج مقاطع تفكير متتابعة، فيما يتلقّى دماغ التعبير المقطع ويولّد الكلام فورًا مركّبًا إياه على ما سبق من الرد. ويتوازى الدماغان على هيئة خط أنابيب، فلا يلزم انتظار اكتمال التفكير كله ليسمع المستخدم الجملة الأولى.


يحقّق النموذج الموحّد "التفكير أثناء الكلام" على أوثق نحو، وثمنه أن التفكير والتعبير الآني يحتاجان إلى إعادة تدريب معًا؛ أما المسار المفكّك فيسهل فيه استبدال دماغ الخلفية، بينما يناسب المسار الموحّد المشاهد المتخصّصة التي تنشد أقصى درجات الطبيعية. وهما مفاضلة، لا بديل أحدهما عن الآخر ببساطة.
...
>
> استخدم Fish Audio S1 لبناء مكتبة صوتية متعددة المراجع وقارن: بلا علامات، ومرجع واحد، ومراجع متعددة. تختار طبقة التنفيذ العاطفة والسرعة والأسلوب المناسبين للعلامات. حقق إعداد المراجع المتعددة أعلى نتيجة في ثلاث جولات استماع عمياء متوازنة (4.67/5 في شبه موظف خدمة عملاء بشري)، لكن لم يظهر الترتيب المخطط كاملًا لأن إعداد بلا علامات تفوق على المرجع المفرد. توحي النتيجة بأن التحكم التعبيري مفيد، لكنها ليست حكمًا عامًا من دراسة استماع صغيرة. المكتبة الكاملة ذات المراجع الأربعة والعشرين ووسائط A/B/C وسجل القبول في [chapter6/controllable-tts](../chapter6/controllable-tts/).
...
>
> يستخدم المسار B مثال الكود في [`chapter6/computer-use-open-model`](../chapter6/computer-use-open-model/). ويشغّل افتراضيًا browser-use بالنموذج المفتوح الأوزان Qwen3-VL 32B Instruct عبر API مستضاف من OpenRouter، أو بتوجيه `OPEN_MODEL_BASE_URL` إلى vLLM/SGLang مستضاف ذاتيًا أو نقطة نهاية متوافقة.
...
ما يحتاج إلى إعادة التصميم ليس واجهة الفعل، بل **واجهة الملاحظة**[^ch6-9]. تحوّل واجهة ملاحظة Agent–الحاسوب (AOI) الرصد المستمر للبيئة إلى أحداث منفصلة يسهل على النموذج معالجتها. وتقنياتها الأساسية هي: **التقاط الإطارات المفتاحية بين اللقطات**، بتجاوز الشاشات شبه الثابتة واستخدام نموذج صغير للاحتفاظ بالتغييرات المهمة فقط؛ و**نسخ الكلام المحكوم بمستوى الصوت**، فلا يُستدعى التعرف إلا عند وجود صوت؛ و**وصف الإطارات كنص**، كي يبقى الوصف في الذاكرة بعد خروج الصورة الأصلية من السياق ويضغط تاريخ التفاعل متعدد الوسائط.
