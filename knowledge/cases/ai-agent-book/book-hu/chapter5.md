...
Miért bírja el a kódgenerálás ezt a súlyt? Mert nem csupán egy eszköz a szerszámosládában, hanem egy "meta-képesség" — az a képesség, hogy futásidőben dinamikusan hozzunk létre új eszközöket és képességeket. A fejezet második fele bontja ki teljesen ezt a koncepciót, valamint azt a hat irányt, amelyben alkalmazható.
