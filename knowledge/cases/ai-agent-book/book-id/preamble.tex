% ===== ElegantBook customizations for the Indonesian edition =====
% Accent color comes from ElegantBook's cyan theme: \structurecolor = RGB(31,186,190)

% ── Indonesian labels for the ElegantBook English layout ─────────
...
% ── Residual CJK glyphs ──────────────────────────────────────────
% This is an Indonesian book, but a handful of Han characters still appear as
% inline examples (Chinese tokenization, translation, and speech-recognition
...
% Internal cross-reference links (Gambar N-M / Bab N) — clickable + subtle teal,
...
\newtcolorbox{questionbox}{
  ...
  title={\sffamily\bfseries Renungan Mendalam},
