...
According to academic conventions: the figure itself does not contain a title (the title is written in the main text). This script only handles "hand-crafted SVGs"—
for SVGs generated by tools, set OMIT_TITLE=True in svg_lib.py.
