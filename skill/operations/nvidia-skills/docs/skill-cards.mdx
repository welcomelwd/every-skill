...
| Requirements / Dependencies |  What components are needed for the skill to run successfully? |
...
Requires API Key or External Credential: [Yes / No / Optional / Not Specified] 
Credential Type(s): [API key, OAuth Token, Cloud Credentials, Service Account, None, Other [Specify]]  
