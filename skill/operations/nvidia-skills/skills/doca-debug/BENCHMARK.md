...
Evaluation of the `doca-debug` skill before publication through Skill Evaluator.
...
| Correctness | 4 | 80% (+20%) | 100% (+15%) |
| Discoverability | 4 | 100% (+62%) | 94% (+47%) |
| Effectiveness | 4 | 78% (+58%) | 100% (+60%) |
| Efficiency | 4 | 98% (+60%) | 100% (+68%) |
...
- MEDIUM SCHEMA/body_recommended_section: Missing recommended section: '## Instructions' (`skills/doca-debug/SKILL.md`)
- MEDIUM SCHEMA/body_recommended_section: Missing recommended section: '## Examples' (`skills/doca-debug/SKILL.md`)
- MEDIUM SCHEMA/author_missing: Author not specified in metadata (`skills/doca-debug/SKILL.md`)
- LOW SCHEMA/unexpected_file: Unexpected 'CAPABILITIES.md' in skill root (`skills/doca-debug/CAPABILITIES.md`)
- LOW SCHEMA/unexpected_file: Unexpected 'TASKS.md' in skill root (`skills/doca-debug/TASKS.md`)
