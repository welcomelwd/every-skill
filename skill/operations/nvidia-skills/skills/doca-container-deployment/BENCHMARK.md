...
Evaluation of the `doca-container-deployment` skill before publication through Skill Evaluator.
...
| Correctness | 3 | 100% (+33%) | 100% (+20%) |
| Discoverability | 3 | 100% (+33%) | 94% (+44%) |
| Effectiveness | 3 | 100% (+84%) | 93% (+76%) |
| Efficiency | 3 | 100% (+33%) | 96% (+62%) |
...
- MEDIUM SCHEMA/body_recommended_section: Missing recommended section: '## Instructions' (`skills/doca-container-deployment/SKILL.md`)
- MEDIUM SCHEMA/body_recommended_section: Missing recommended section: '## Examples' (`skills/doca-container-deployment/SKILL.md`)
- MEDIUM SCHEMA/author_missing: Author not specified in metadata (`skills/doca-container-deployment/SKILL.md`)
- LOW SCHEMA/unexpected_file: Unexpected 'CAPABILITIES.md' in skill root (`skills/doca-container-deployment/CAPABILITIES.md`)
- LOW SCHEMA/unexpected_file: Unexpected 'TASKS.md' in skill root (`skills/doca-container-deployment/TASKS.md`)
