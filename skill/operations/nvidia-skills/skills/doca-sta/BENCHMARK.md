...
Evaluation of the `doca-sta` skill before publication through Skill Evaluator.
...
- MEDIUM SCHEMA/folder_hierarchy: Unexpected nesting depth for general skill (`skills/libs/doca-sta`)
- MEDIUM SCHEMA/body_recommended_section: Missing recommended section: '## Instructions' (`skills/libs/doca-sta/SKILL.md`)
- MEDIUM SCHEMA/body_recommended_section: Missing recommended section: '## Examples' (`skills/libs/doca-sta/SKILL.md`)
- MEDIUM SCHEMA/author_missing: Author not specified in metadata (`skills/libs/doca-sta/SKILL.md`)
- LOW SCHEMA/unexpected_file: Unexpected 'SKILLCARD.yaml' in skill root (`skills/libs/doca-sta/SKILLCARD.yaml`)
