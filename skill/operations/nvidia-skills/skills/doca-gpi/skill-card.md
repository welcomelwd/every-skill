## Description: <br>
Use this skill for hands-on DOCA GPI programming — wiring a GPU-Packet-Initiator context so a CUDA kernel drives RDMA queues directly from GPU memory without host CPU mediation. <br>
...
## Use Case: <br>
External developers building GPU-resident DOCA applications that need to drive RDMA queues directly from CUDA kernels without host CPU mediation. <br>
