# Skill Benchmark: nemo-mbridge-perf-sequence-packing
...
- **LOW** SCHEMA/unexpected_file: Unexpected 'card.yaml' in skill root (`skills/nemo-mbridge-perf-sequence-packing/card.yaml`)
