...
Evaluation of the `i4h-catheter-navigation-viewport` skill before publication through Skill Evaluator.
...
|---|---:|---:|---:|
| Security | 4 | 100% (+0%) | 100% (+38%) |
| Correctness | 4 | 85% (+40%) | 80% (+30%) |
| Discoverability | 4 | 92% (+30%) | 84% (+25%) |
| Effectiveness | 4 | 62% (+25%) | 71% (+19%) |
| Efficiency | 4 | 98% (+44%) | 95% (+24%) |
...
- MEDIUM SCHEMA/frontmatter_field_placement: Root field 'version' is ignored; use 'metadata.version' (`team-skills/holoscan/i4h-workflows/i4h-catheter-navigation-viewport/SKILL.md`)
- MEDIUM SCHEMA/body_recommended_section: Missing recommended section: '## Instructions' (`team-skills/holoscan/i4h-workflows/i4h-catheter-navigation-viewport/SKILL.md`)
- MEDIUM SCHEMA/body_recommended_section: Missing recommended section: '## Examples' (`team-skills/holoscan/i4h-workflows/i4h-catheter-navigation-viewport/SKILL.md`)
