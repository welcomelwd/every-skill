...
Evaluation of the `doca-spcx-cc` skill before publication through Skill Evaluator.
...
- MEDIUM SCHEMA/folder_hierarchy: Unexpected nesting depth for general skill (`skills/tools/doca-spcx-cc`)
- MEDIUM SCHEMA/body_recommended_section: Missing recommended section: '## Instructions' (`skills/tools/doca-spcx-cc/SKILL.md`)
- MEDIUM SCHEMA/body_recommended_section: Missing recommended section: '## Examples' (`skills/tools/doca-spcx-cc/SKILL.md`)
- MEDIUM SCHEMA/author_missing: Author not specified in metadata (`skills/tools/doca-spcx-cc/SKILL.md`)
- LOW SCHEMA/unexpected_file: Unexpected 'CAPABILITIES.md' in skill root (`skills/tools/doca-spcx-cc/CAPABILITIES.md`)
