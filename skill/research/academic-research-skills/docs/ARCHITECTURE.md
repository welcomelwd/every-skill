# ARS Pipeline Architecture (v3.20.0)
...
```mermaid
graph TD
    Pipeline[academic-pipeline<br/>orchestrator<br/>v3.20.0<br/>Agent Team: 5]
    Observer[collaboration_depth_agent<br/>observer · advisory only<br/>blocking: false]
    DR[deep-research<br/>13 agents<br/>v2.12.0<br/>+ corpus reader]
    AP[academic-paper<br/>12 agents<br/>v3.3.0<br/>+ corpus reader]
    APR[academic-paper-reviewer<br/>7 agents<br/>v1.11.0]
...
| Skill | Modes |
|---|---|
| `deep-research` v2.12.0 | full, quick, socratic, review, lit-review, three-way-scan, fact-check, systematic-review (8) |
| `academic-paper` v3.3.0 | full, plan, outline-only, revision, revision-coach, abstract-only, lit-review, format-convert, citation-check, disclosure, rebuttal-audit (11) |
| `academic-paper-reviewer` v1.11.0 | full, re-review, quick, methodology-focus, guided, calibration (6) |
