...
✅ **Downloaded 2,016+ skill files** to your computer (default: `~/.agents/skills/`; or a custom path like `~/.agent/skills/` if you used `--path`)
...
Don't try to use all 2,016+ skills at once. Here's a sensible approach:
...
No. Even though you have 2,016+ skills installed locally, you should **not** concatenate every `SKILL.md` into a single system prompt or context block.
