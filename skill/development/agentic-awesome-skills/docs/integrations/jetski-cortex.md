...
description: "Use agentic-awesome-skills with Jetski/Cortex without hitting context-window overflow with 2,016+ skills."
---

# Jetski/Cortex + Gemini: safe integration with 2,016+ skills
...
With 2,016+ skills, this approach fills the context window before user messages are even added, causing truncation.
