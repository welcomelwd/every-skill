...
- [get-you-some-britches](https://clawskills.sh/skills/am-will-get-you-some-britches) - Use this skill any time I start complaining.
- [graphiti](https://clawskills.sh/skills/emasoudy-graphiti) - Knowledge graph operations via Graphiti API.
- [gutcheck](https://clawskills.sh/skills/allen566-gutcheck) - GutCheck - A digestive health tracking application with personalized.
- [id-cv-resume-creator](https://clawskills.sh/skills/rotorstar-id-cv-resume-creator) - Create free interactive digital identities.
- [joko-jobhunter](https://clawskills.sh/skills/oyi77-joko-jobhunter) - Aggressive job hunting skill with research, outreach.
- [learn-cog](https://clawskills.sh/skills/nitishgargiitd-learn-cog) - The best tutors explain the same concept five different ways.
- [lunchtable-tcg](https://clawskills.sh/skills/dexploarer-lunchtable-tcg) - Play LunchTable-TCG, a Yu-Gi-Oh-inspired online trading card.
- [memepickup-wingman](https://clawskills.sh/skills/samcraw1-memepickup-wingman) - Dating wingman that generates openers, replies, profile analysis, date plans, and coaching via the MemePickup API.
- [mindfulness-meditation](https://clawskills.sh/skills/jhillin8-mindfulness-meditation) - Build a meditation practice with guided.
- [moltvote-ai](https://clawskills.sh/skills/amaze28-moltvote-ai) - Vote on polls as yourself or your human.
- [morning-routine](https://clawskills.sh/skills/jhillin8-morning-routine) - Build a powerful morning routine with habit checklists.
- [nova-net-worth](https://clawskills.sh/skills/jessewunderlich-nova-net-worth) - Query your Nova Net Worth financial data — net worth, accounts, goals, spending, transactions, AI insights.
- [open-lesson](https://clawskills.sh/skills/dncolomer-open-lesson) - You are an AI agent that can interact with the openLesson tutoring platform via API.
- [personal-nutrition](https://clawskills.sh/skills/gekacross-personal-nutrition) - Acts as the user's personal nutrition coach in the Nutrition topic.
- [pine-voice](https://clawskills.sh/skills/bojieli-pine-voice) - Give your agent a real phone.
- [post-job](https://clawskills.sh/skills/zhangdong-post-job) - Post free job ads to 20+ job boards such as LinkedIn, Indeed, Ziprecruiter etc. to receive applicant resumes via email.
- [shelter](https://clawskills.sh/skills/code-with-brian-shelter) - Connect to your Shelter financial data.
