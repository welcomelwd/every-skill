...
Evaluation of the `i4h-catheter-navigation` skill before publication through Skill Evaluator.
...
|---|---:|---:|---:|
| Security | 4 | 75% (-25%) | 75% (-25%) |
| Correctness | 4 | 90% (+55%) | 100% (+55%) |
| Discoverability | 4 | 98% (+36%) | 94% (+34%) |
| Effectiveness | 4 | 75% (+36%) | 91% (+46%) |
| Efficiency | 4 | 98% (+35%) | 100% (+49%) |
...
- MEDIUM SCHEMA/frontmatter_field_placement: Root field 'version' is ignored; use 'metadata.version' (`team-skills/holoscan/i4h-workflows/i4h-catheter-navigation/SKILL.md`)
- MEDIUM SCHEMA/body_recommended_section: Missing recommended section: '## Instructions' (`team-skills/holoscan/i4h-workflows/i4h-catheter-navigation/SKILL.md`)
- MEDIUM SCHEMA/body_recommended_section: Missing recommended section: '## Examples' (`team-skills/holoscan/i4h-workflows/i4h-catheter-navigation/SKILL.md`)
