...
1. `$USD_OPTIMIZE_ROOT/.agents/skills/create-proxy/references/bounding-box-modes.md`
2. `$USD_OPTIMIZE_ROOT/.agents/skills/create-proxy/references/bounding-box-modes.md`
