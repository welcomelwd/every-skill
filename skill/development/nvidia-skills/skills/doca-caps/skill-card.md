...
## Use Case: <br>
External operators, developers, and AI agents who need a side-effect-free way to ask what DOCA sees on this host before doing anything that changes state — confirming hardware visibility, library availability, and per-device capabilities. <br>
