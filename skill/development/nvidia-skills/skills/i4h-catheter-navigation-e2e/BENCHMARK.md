...
Evaluation of the `i4h-catheter-navigation-e2e` skill before publication through Skill Evaluator.
...
- MEDIUM SCHEMA/frontmatter_field_placement: Root field 'version' is ignored; use 'metadata.version' (`team-skills/holoscan/i4h-workflows/i4h-catheter-navigation-e2e/SKILL.md`)
- MEDIUM SCHEMA/body_recommended_section: Missing recommended section: '## Instructions' (`team-skills/holoscan/i4h-workflows/i4h-catheter-navigation-e2e/SKILL.md`)
- MEDIUM SCHEMA/body_recommended_section: Missing recommended section: '## Examples' (`team-skills/holoscan/i4h-workflows/i4h-catheter-navigation-e2e/SKILL.md`)
