...
Evaluation of the `tao-run-on-docker` skill before publication through Skill Evaluator.
...
| Correctness | 1 | 100% (+100%) | 100% (+100%) |
| Discoverability | 1 | 100% (+100%) | 94% (+94%) |
| Effectiveness | 1 | 100% (+83%) | 83% (+35%) |
| Efficiency | 1 | 83% (+83%) | 100% (+100%) |
...
- LOW SCHEMA/author_format: Author must be of the form 'Name <email@host>' (`skills/platform/tao-run-on-docker/SKILL.md`)
