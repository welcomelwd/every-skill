...
## Use Case: <br>
Developers and engineers integrating DOCA SHA hardware acceleration into existing OpenSSL-based pipelines performing SHA-1, SHA-256, or SHA-512 hashing, enabling offload onto BlueField DPU or ConnectX NIC without application rewrites. <br>
