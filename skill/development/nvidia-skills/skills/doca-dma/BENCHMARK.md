...
Evaluation of the `doca-dma` skill before publication through Skill Evaluator.
...
| Correctness | 4 | 100% (+20%) | 100% (+20%) |
| Discoverability | 4 | 100% (+50%) | 95% (+36%) |
| Effectiveness | 4 | 87% (+30%) | 100% (+40%) |
| Efficiency | 4 | 95% (+58%) | 92% (+61%) |
...
- MEDIUM SCHEMA/folder_hierarchy: Unexpected nesting depth for general skill (`skills/libs/doca-dma`)
- MEDIUM SCHEMA/body_recommended_section: Missing recommended section: '## Instructions' (`skills/libs/doca-dma/SKILL.md`)
- MEDIUM SCHEMA/body_recommended_section: Missing recommended section: '## Examples' (`skills/libs/doca-dma/SKILL.md`)
- MEDIUM SCHEMA/author_missing: Author not specified in metadata (`skills/libs/doca-dma/SKILL.md`)
- LOW SCHEMA/unexpected_file: Unexpected 'CAPABILITIES.md' in skill root (`skills/libs/doca-dma/CAPABILITIES.md`)
