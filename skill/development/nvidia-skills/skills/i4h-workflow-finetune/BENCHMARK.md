...
Evaluation of the `i4h-workflow-finetune` skill before publication through NVSkills-Eval.
...
- MEDIUM SCHEMA/body_recommended_section: Missing recommended section: '## Instructions' (`team-skills/holoscan/i4h-workflows/i4h-workflow-finetune/SKILL.md`)
- MEDIUM SCHEMA/body_recommended_section: Missing recommended section: '## Examples' (`team-skills/holoscan/i4h-workflows/i4h-workflow-finetune/SKILL.md`)
