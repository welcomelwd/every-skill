# Skill Benchmark: rtvi-cv-scaffold-vss-service
...
- Dataset digest: `sha256:401fba496bce5a42048bf6833a613cb923e36ddf8de7626d2efcbbfbe5c0d0fb` (skill-evaluator-dataset-snapshot/1)
- Attempts per task: 1
...
- **MEDIUM** SCHEMA/metadata_key_style: Metadata key 'data_classification' is not kebab-case (`skills/rtvi-cv-scaffold-vss-service/SKILL.md`)
- **LOW** SCHEMA/unexpected_file: Unexpected 'nvbase.json' in skill root (`skills/rtvi-cv-scaffold-vss-service/nvbase.json`)
