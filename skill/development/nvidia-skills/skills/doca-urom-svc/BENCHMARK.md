...
Evaluation of the `doca-urom-svc` skill before publication through Skill Evaluator.
...
| Correctness | 4 | 100% (+50%) | 100% (+30%) |
| Discoverability | 4 | 100% (+25%) | 95% (+34%) |
| Effectiveness | 4 | 88% (+59%) | 94% (+59%) |
| Efficiency | 4 | 94% (+43%) | 83% (+55%) |
...
- MEDIUM SCHEMA/folder_hierarchy: Unexpected nesting depth for general skill (`skills/services/doca-urom-svc`)
- MEDIUM SCHEMA/body_recommended_section: Missing recommended section: '## Instructions' (`skills/services/doca-urom-svc/SKILL.md`)
- MEDIUM SCHEMA/body_recommended_section: Missing recommended section: '## Examples' (`skills/services/doca-urom-svc/SKILL.md`)
- MEDIUM SCHEMA/author_missing: Author not specified in metadata (`skills/services/doca-urom-svc/SKILL.md`)
- LOW SCHEMA/unexpected_file: Unexpected 'SKILLCARD.yaml' in skill root (`skills/services/doca-urom-svc/SKILLCARD.yaml`)
