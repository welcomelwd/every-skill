...
| 11 | `11-team-metrics` | `11-team-metrics` | `guide/ops/team-metrics.md`, `guide/ops/observability.md` |
| 12 | `12-agent-engineering` | `12-agent-engineering` | Ch.9 agent teams, `guide/core/methodologies.md` |
...
| `series` value is consistent | 2 | Equals "Claude Code Ultimate Guide" |
