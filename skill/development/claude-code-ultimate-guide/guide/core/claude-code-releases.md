...
- ⭐ **Added**: Cross-session `SendMessage`. Claude Code sessions can message each other, on any of your machines, with `ListAgents` to discover them (macOS and Linux)
