...
For detailed instructions, follow the [observability instructions](/docs/observability/overview). To get up and running quickly, add the `@mastra/observability` package to your project and configure it with [LibSQL](/integrations/databases/libsql) and [DuckDB](/reference/vectors/duckdb) for a local development setup that supports both traces and metrics.
