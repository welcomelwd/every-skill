...
- [Vercel Sandbox](/integrations/sandboxes/vercel#vercel-sandbox) (`@mastra/vercel`)
- [E2B](/integrations/sandboxes/e2b) (`@mastra/e2b`)
- [Daytona](/integrations/sandboxes/daytona) (`@mastra/daytona`)
...
- The sandbox URL is public. Anyone with the URL can reach your Mastra server, including Studio. Enable [server auth](/docs/auth/overview) for anything beyond throwaway previews.
