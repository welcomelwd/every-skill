...
- [Auth overview](/docs/auth/overview): Available auth providers and how they work
- [Token-based auth](/docs/auth/simple-auth): Token-to-user mapping authentication
- [Worker deployment](/docs/deployment/workers): Set up split worker processes
