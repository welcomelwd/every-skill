---
title: "Storage exporter | Observability"
...
| - | - | - | - |
| **[ClickHouse](/integrations/databases/clickhouse)** | insert-only | insert-only | Production (high-volume) |
| **[PostgreSQL](/integrations/databases/postgresql)** | batch-with-updates | batch-with-updates, insert-only | Production (low volume) |
| **[MSSQL](/integrations/databases/mssql)** | batch-with-updates | batch-with-updates, insert-only | Production (low volume) |
| **[MongoDB](/integrations/databases/mongodb)** | batch-with-updates | batch-with-updates, insert-only | Production (low volume) |
| **[OracleDB](/integrations/databases/oracledb)** | batch-with-updates | batch-with-updates, insert-only | Production (low volume) |
| **[libSQL](/integrations/databases/libsql)** | batch-with-updates | batch-with-updates, insert-only | Default storage, good for development |
...
- [Cloudflare Durable Objects](/integrations/databases/cloudflare-kv)
...
[ClickHouse](/integrations/databases/clickhouse) is a columnar database designed for high-volume analytics workloads. It's the recommended choice for production observability because:
...
- [MastraPlatformExporter](/docs/mastra-platform/observability)
- [Composite Storage](/reference/storage/composite): Combine multiple storage providers
- [Storage Configuration](/docs/storage)
