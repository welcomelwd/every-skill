...
description: Connect Mastra agents to external MCP servers and expose Mastra tools through MCPServer. You can also build interactive MCP Apps for Studio.
packages:
  - "@mastra/mcp"
---
...
```typescript title="src/mastra/mcp/stdio.ts"
#!/usr/bin/env node
...
- [Use tools with agents](/docs/agents/tools)
