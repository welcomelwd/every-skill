...
The Mastra Client SDK provides a concise and type-safe interface for interacting with your [Mastra Server](/docs/server/overview) from your client environment.
...
- **[A2A](/docs/connections/a2a)**: Discover agents through agent cards and work with task-based A2A streams.
