...
Server deploy provisions hosted storage automatically. If you override storage with [LibSQLStore](/integrations/databases/libsql) and a file URL, switch to a remotely hosted database because Mastra platform uses an ephemeral filesystem.
