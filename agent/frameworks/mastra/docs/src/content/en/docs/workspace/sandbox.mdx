...
- [`AgentCoreRuntimeSandbox`](/integrations/sandboxes/agentcore): Executes commands in AWS Bedrock AgentCore Runtime sessions
- [`AppleContainerSandbox`](/integrations/sandboxes/apple-container): Executes commands in local OCI Linux containers using Apple's `container` CLI
- [`BlaxelSandbox`](/integrations/sandboxes/blaxel): Executes commands in isolated Blaxel cloud sandboxes
- [`DaytonaSandbox`](/integrations/sandboxes/daytona): Executes commands in isolated Daytona cloud sandboxes
- [`DockerSandbox`](/integrations/sandboxes/docker): Executes commands in long-lived Docker containers on the local machine
- [`E2BSandbox`](/integrations/sandboxes/e2b): Executes commands in isolated E2B cloud sandboxes
- [`ModalSandbox`](/integrations/sandboxes/modal): Executes commands in isolated Modal cloud sandboxes
...
- [`RailwaySandbox`](/integrations/sandboxes/railway): Executes commands in ephemeral, isolated Railway cloud sandboxes
- [`VercelSandbox`](/integrations/sandboxes/vercel#vercel-sandbox): Executes commands in an ephemeral Vercel Sandbox Firecracker MicroVM
- [`VercelServerlessSandbox`](/integrations/sandboxes/vercel#vercel-serverless-sandbox): Executes commands as stateless Vercel serverless functions
...
- [`AgentCoreRuntimeSandbox` reference](/integrations/sandboxes/agentcore)
- [`AppleContainerSandbox` reference](/integrations/sandboxes/apple-container)
...
- [`ModalSandbox` reference](/integrations/sandboxes/modal)
- [`VercelSandbox` reference](/integrations/sandboxes/vercel#vercel-sandbox)
- [`VercelServerlessSandbox` reference](/integrations/sandboxes/vercel#vercel-serverless-sandbox)
