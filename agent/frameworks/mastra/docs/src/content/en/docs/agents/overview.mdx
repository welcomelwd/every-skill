...
| Human-in-the-loop: Pause execution and wait for human approval | [Human-in-the-loop](/docs/agents/agent-approval) |
...
| Connect to Slack, Discord, or Telegram | [Channels](/docs/capabilities/channels) |
