...
See [Channels](/docs/capabilities/channels) for adapter setup and platform-specific webhook configuration.
...
- [Workspace](/docs/workspace/sandbox)
- [Observational memory](/docs/memory/observational-memory)
- [Channels](/docs/capabilities/channels)
