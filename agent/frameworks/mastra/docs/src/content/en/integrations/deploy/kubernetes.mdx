---
title: "Deploy Mastra to Kubernetes | Deploy"
...
:::beta
Multi-pod support relies on [durable agents](/docs/long-running-agents/durable-agents). Breaking changes may occur without a major version bump until the API is stable. Read [Known limitations](#known-limitations) before you rely on this in production.
:::
