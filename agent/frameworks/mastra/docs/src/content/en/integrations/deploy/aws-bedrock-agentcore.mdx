---
title: "Deploy Mastra to Amazon Bedrock AgentCore | Deploy"
...
For a Lambda-based deployment of the full Mastra server, see the [AWS Lambda guide](/integrations/deploy/aws-lambda). For a long-lived virtual machine, see the [Amazon EC2 guide](/integrations/deploy/amazon-ec2).
