...
description: "API reference for CloudflareSandbox, a Workspace sandbox provider that executes commands through a Cloudflare Sandbox Bridge Worker."
packages:
...
Deploy and secure a [Sandbox Bridge Worker](https://developers.cloudflare.com/sandbox/bridge/) before using this provider. The bridge can create and delete sandboxes, execute commands, and write files on behalf of its callers.
