...
- [OtelExporter Guide](/integrations/observability/opentelemetry#exporter): Setup guide with provider configurations
- [OtelBridge](/integrations/observability/opentelemetry#bridge): For bidirectional OTEL context integration
