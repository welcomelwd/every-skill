...
<Tabs>
  <TabItem value="openai" label="OpenAI">
    ...
    Visit the [OpenAI Voice Reference](/integrations/voice/openai#voice) for more information on the OpenAI voice provider.
  </TabItem>
  ...
  <TabItem value="azure" label="Azure">
    ...
    Visit the [Azure Voice Reference](/integrations/voice/azure) for more information on the Azure voice provider.
  </TabItem>
  ...
  <TabItem value="elevenlabs" label="ElevenLabs">
    ...
    Visit the [ElevenLabs Voice Reference](/integrations/voice/elevenlabs) for more information on the ElevenLabs voice provider.
  </TabItem>
  ...
  <TabItem value="google" label="Google">
    ...
    Visit the [Google Voice Reference](/integrations/voice/google#speech) for more information on the Google voice provider.
  </TabItem>
  ...
  <TabItem value="cloudflare" label="Cloudflare">
    ...
    Visit the [Cloudflare Voice Reference](/integrations/voice/cloudflare) for more information on the Cloudflare voice provider.
  </TabItem>
  ...
  <TabItem value="deepgram" label="Deepgram">
    ...
    Visit the [Deepgram Voice Reference](/integrations/voice/deepgram) for more information on the Deepgram voice provider.
  </TabItem>
  ...
  <TabItem value="inworld" label="Inworld">
    ...
    Visit the [Inworld Voice Reference](/integrations/voice/inworld#voice) for more information on the Inworld voice provider.
  </TabItem>
  ...
  <TabItem value="speechify" label="Speechify">
    ...
    Visit the [Speechify Voice Reference](/integrations/voice/speechify) for more information on the Speechify voice provider.
  </TabItem>
  ...
  <TabItem value="sarvam" label="Sarvam">
    ...
    Visit the [Sarvam Voice Reference](/integrations/voice/sarvam) for more information on the Sarvam voice provider.
  </TabItem>
  ...
  <TabItem value="murf" label="Murf">
    ...
    Visit the [Murf Voice Reference](/integrations/voice/murf) for more information on the Murf voice provider.
  </TabItem>
</Tabs>
...
<Tabs>
  <TabItem value="openai" label="OpenAI">
    ...
    Visit the [OpenAI Voice Reference](/integrations/voice/openai#realtime) for more information on the OpenAI voice provider.
  </TabItem>
  ...
  <TabItem value="google" label="Google">
    ...
    Visit the [Google Gemini Live Reference](/integrations/voice/google#gemini-live) for more information on the Google Gemini Live voice provider.
  </TabItem>
  ...
  <TabItem value="aws-nova-sonic" label="AWS Nova Sonic">
    ...
    Visit the [AWS Nova Sonic Reference](/integrations/voice/aws-nova-sonic) for more information on the AWS Nova Sonic voice provider.
  </TabItem>
  ...
  <TabItem value="inworld-realtime" label="Inworld Realtime">
    ...
    Visit the [Inworld Realtime Reference](/integrations/voice/inworld#realtime) for more information on the Inworld Realtime voice provider.
  </TabItem>
...
<Tabs>
  ...
  <TabItem value="openai-realtime" label="OpenAI Realtime">
    ...
    For more information on the OpenAI Realtime voice provider, refer to the [OpenAI Realtime Voice Reference](/integrations/voice/openai#realtime).
  </TabItem>
  ...
  <TabItem value="xai-realtime" label="xAI Realtime">
    ...
    Visit the [xAI Realtime Voice Reference](/integrations/voice/xai) for more information on the xAI realtime voice provider.
  </TabItem>
...
- [OpenAI Voice](/integrations/voice/openai#voice)
- [OpenAI Realtime Voice](/integrations/voice/openai#realtime)
- [xAI Realtime Voice](/integrations/voice/xai)
- [Azure Voice](/integrations/voice/azure)
- [Google Voice](/integrations/voice/google#speech)
- [Google Gemini Live Voice](/integrations/voice/google#gemini-live)
- [AWS Nova Sonic Voice](/integrations/voice/aws-nova-sonic)
- [Deepgram Voice](/integrations/voice/deepgram)
- [Inworld Voice](/integrations/voice/inworld#voice)
- [LiveKit](/integrations/voice/livekit#api-reference)
