...
For everyday AI-assisted development with Mastra skills and the CLI, see [Develop](/docs/develop#build-with-ai). This page covers other ways to give coding agents access to Mastra documentation.
...
The MCP docs server isn't recommended for everyday development. Use the [Mastra skill](/docs/develop#mastra-skill) instead because it's more up to date and performs better.
