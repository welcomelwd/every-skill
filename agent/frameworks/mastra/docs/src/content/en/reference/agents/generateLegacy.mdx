...
The new `.generate()` method offers enhanced capabilities including compatibility with AI SDK v5 and later, better structured output handling, and improved streaming support. See the [migration guide](/reference/migrations/vnext-to-standard-apis) for detailed migration instructions.
