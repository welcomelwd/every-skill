...
description: "API reference for createCodingAgent(), which builds a coding agent with the essential defaults for workspace, task signals with memory, error retries, and goal judge."
packages:
  - "@mastra/core"
---
