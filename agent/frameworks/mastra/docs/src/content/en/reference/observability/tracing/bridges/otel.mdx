...
See the [OtelBridge Guide](/integrations/observability/opentelemetry#bridge) for complete setup instructions, including how to configure OTEL instrumentation and run your application.
...
- [OtelBridge Guide](/integrations/observability/opentelemetry#bridge): Setup guide with examples
