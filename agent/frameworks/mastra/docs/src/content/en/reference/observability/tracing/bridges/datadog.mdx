...
See the [DatadogBridge Guide](/integrations/observability/datadog#bridge) for complete setup instructions, including dd-trace initialization, bundler externals, and agent configuration.
...
- [DatadogBridge Guide](/integrations/observability/datadog#bridge) - Setup guide with examples
