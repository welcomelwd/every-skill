...
<PropertiesTable
  ...
  },
  {
    ...
    type: "'v5' | 'v6' | 'v7'",
    description:
      "Selects the AI SDK message type to return. Omit it or pass `'v5'` for the existing default behavior. Pass `'v6'` when your app is typed against AI SDK v6 `useChat()` message types. Pass `'v7'` when your app is typed against AI SDK v7.",
    isOptional: true,
  },
]}
/>
