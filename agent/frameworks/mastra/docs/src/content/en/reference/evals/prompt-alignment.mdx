  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        description:
          'Include prior conversation turns from the agent memory in the judge prompt so short replies are scored in context (default: false). Pass an object to cap how many recent messages are included (default: 10). Only applies to agent runs that carry remembered messages.',
        required: false,
      },
    ],
  },
