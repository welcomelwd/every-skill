...
Visit the [Background tasks documentation](/docs/harness/background-tasks) to learn more.
...
Visit the [MCP Overview](/docs/connections/mcp) to learn more.
...
Visit the [Storage documentation](/docs/storage) to learn more.
...
Visit the [Tools documentation](/docs/agents/tools) to learn more.
...
Visit the [Voice documentation](/reference/voice/overview) to learn more.
...
Visit the [RAG documentation](/reference/rag/overview) to learn more.
...
See the [Workspace documentation](/docs/sandbox/overview) for implementation details.
...
Visit the [Authentication documentation](/docs/auth/overview) to learn more.
...
- Your handler has no access to the HTTP server handle in the generated entry file, so it can't drain in-flight HTTP requests. If you only need a longer drain window, prefer [`server.drainTimeout`](#serverdraintimeout). For full control over the server lifecycle, use a [server adapter](/docs/server/server-adapters).
