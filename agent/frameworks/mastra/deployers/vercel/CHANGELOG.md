...
- Fixed Vercel Studio deployments so the root URL serves the Studio app when Studio assets are enabled. ([#18325](https://github.com/mastra-ai/mastra/pull/18325))
