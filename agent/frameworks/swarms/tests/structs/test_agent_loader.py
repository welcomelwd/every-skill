...
def test_load_agents_from_markdown_single_file():
    ...
    try:
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            logger.info(
                f"✓ Load agents from markdown (single file) test passed: {len(agents)} agents loaded"
            )
...
def test_load_agents_from_markdown_multiple_files():
    ...
    try:
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            logger.info(
                f"✓ Load agents from multiple markdown files test passed: {len(agents)} agents loaded"
            )
...
def test_load_agents_from_yaml():
    ...
    try:
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            logger.info(
                f"✓ Load agents from YAML test passed: {len(agents)} agents loaded"
            )
...
def test_load_many_agents_from_yaml():
    ...
    try:
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            logger.info(
                f"✓ Load many agents from YAML test passed: {len(agents_lists)} file(s) processed"
            )
...
def test_load_agents_from_csv():
    ...
    try:
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            logger.info(
                f"✓ Load agents from CSV test passed: {len(agents)} agents loaded"
            )
...
def test_auto_unsupported_file_type():
    ...
    try:
        ...
        try:
            ...
            logger.info(
                "✓ Auto-detect unsupported file type test passed (error handled correctly)"
            )
        except Exception as e:
...
def test_load_multiple_agents():
    ...
    try:
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            logger.info(
                f"✓ Load multiple agents test passed: {len(agents_lists)} file(s) processed"
            )
...
def test_parse_markdown_file():
    ...
    try:
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            logger.info(
                f"✓ Parse markdown file test passed: {agent_config.name}"
            )
...
def test_error_handling_nonexistent_file():
    ...
    try:
        ...
        try:
            ...
            logger.info(
                "✓ Error handling for nonexistent file test passed"
            )
