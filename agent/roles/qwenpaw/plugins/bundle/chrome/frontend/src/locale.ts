...
const messages = {
  en: {
    ...
    openExtensionsSuffix:
      "then paste it into Chrome's address bar and press Enter.",
    ...
    chromeExtensionsCopied:
      "Copied. Paste it into Chrome's address bar and press Enter.",
    chromeExtensionsCopiedFallback:
      "Chrome could not open the extensions page automatically. The address was copied; paste it into Chrome's address bar and press Enter.",
    chrome_disconnected:
