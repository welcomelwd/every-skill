...
Revision ID: 24fedf2ade30
Revises: c7d9e2f1aabc
Create Date: 2025-10-28 03:16:00.210089
...
revision: str = "24fedf2ade30"
down_revision: Union[str, None] = "c7d9e2f1aabc"
...
def upgrade() -> None:
    ...
    op.create_foreign_key(
        op.f("diffs_environment_id_fkey"),
        "diffs",
    ...
    op.create_foreign_key(
        op.f("test_memberships_test_id_fkey"),
        "test_memberships",
        "tests",
        ["test_id"],
        ["id"],
    ...
    op.alter_column("test_runs", "test_id", existing_type=sa.UUID(), nullable=True)
    op.drop_constraint(
    ...
    op.create_foreign_key(
        op.f("test_runs_test_suite_id_fkey"),
        "test_runs",
        "test_suites",
        ["test_suite_id"],
        ["id"],
    ...
    op.create_foreign_key(
        op.f("test_runs_created_by_fkey"),
        "test_runs",
        "users",
        ["created_by"],
        ["id"],
    ...
    op.create_foreign_key(
        op.f("test_runs_environment_id_fkey"),
        "test_runs",
        "run_time_environments",
        ["environment_id"],
        ["id"],
...
def downgrade() -> None:
    # Don't revert - keeping test_id nullable is fine
    pass
