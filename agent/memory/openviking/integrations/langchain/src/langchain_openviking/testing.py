...
from langchain_openviking._testing_utils import estimate_text_tokens, normalize_peer_id
...
class InMemoryOpenVikingClient:
    ...
    def _search(
        ...
        result: dict[str, Any] = {"memories": [], "resources": [], "skills": [], "total": 0}
        for result_score, uri, content in scored[:limit]:
            item = {
                "uri": uri,
                "level": 2,
