> [!NOTE]
> This document is a local copy of the official Kubernetes API Conventions, fetched on 2026-06-04 from `https://github.com/kubernetes/community/blob/master/contributors/devel/sig-architecture/api-conventions.md` (commit 73ae50bca98e9aa4a2285a10620269d3982adafe). It is included here to ensure self-containment for tools without internet access.
