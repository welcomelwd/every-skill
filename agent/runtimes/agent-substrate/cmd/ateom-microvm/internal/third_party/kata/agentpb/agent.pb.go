...
type MemoryStats struct {
	...
	Stats         map[string]uint64      `protobuf:"bytes,6,rep,name=stats,proto3" json:"stats,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type CgroupStats struct {
	...
	HugetlbStats  map[string]*HugetlbStats `protobuf:"bytes,5,rep,name=hugetlb_stats,json=hugetlbStats,proto3" json:"hugetlb_stats,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` // the map is in the format "size of hugepage: stats of the hugepage"
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ARPNeighbors struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ARPNeighbors  []*ARPNeighbor         `protobuf:"bytes,1,rep,name=ARPNeighbors,proto3" json:"ARPNeighbors,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ARPNeighbors) GetARPNeighbors() []*ARPNeighbor {
	if x != nil {
...
type FSGroup struct {
	...
	GroupChangePolicy FSGroupChangePolicy `protobuf:"varint,3,opt,name=group_change_policy,json=groupChangePolicy,proto3,enum=types.FSGroupChangePolicy" json:"group_change_policy,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *FSGroup) GetGroupChangePolicy() FSGroupChangePolicy {
	if x != nil {
		return x.GroupChangePolicy
	}
	return FSGroupChangePolicy_Always
}
...
type GetDiagnosticDataRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *GetDiagnosticDataRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *GetDiagnosticDataRequest) GetContainerId() string {
	if x != nil {
		return x.ContainerId
	}
	return ""
...
type GetDiagnosticDataResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *GetDiagnosticDataResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
var file_agent_proto_goTypes = []any{
	...
	(*Interface)(nil),                             // 77: types.Interface
	(*Route)(nil),                                 // 78: types.Route
	(*ARPNeighbor)(nil),                           // 79: types.ARPNeighbor
	(FSGroupChangePolicy)(0),                      // 80: types.FSGroupChangePolicy
...
func file_agent_proto_init() {
	...
	file_agent_proto_msgTypes[71].OneofWrappers = []any{}
	type x struct{}
