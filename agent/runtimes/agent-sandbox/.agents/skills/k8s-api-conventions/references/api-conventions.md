> [!NOTE]
> This document is a local copy of the official Kubernetes API Conventions, fetched on 2026-05-15 from `https://github.com/kubernetes/community/blob/master/contributors/devel/sig-architecture/api-conventions.md`. It is included here to ensure self-containment for tools without internet access.
