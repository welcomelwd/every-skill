...
type SandboxTemplateLister interface {
	...
	List(selector labels.Selector) (ret []*apiv1beta1.SandboxTemplate, err error)
...
type sandboxTemplateLister struct {
	listers.ResourceIndexer[*apiv1beta1.SandboxTemplate]
}
...
func NewSandboxTemplateLister(indexer cache.Indexer) SandboxTemplateLister {
	return &sandboxTemplateLister{listers.New[*apiv1beta1.SandboxTemplate](indexer, apiv1beta1.Resource("sandboxtemplate"))}
}

// SandboxTemplates returns an object that can list and get SandboxTemplates.
func (s *sandboxTemplateLister) SandboxTemplates(namespace string) SandboxTemplateNamespaceLister {
	return sandboxTemplateNamespaceLister{listers.NewNamespaced[*apiv1beta1.SandboxTemplate](s.ResourceIndexer, namespace)}
}
...
type SandboxTemplateNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*apiv1beta1.SandboxTemplate, error)
