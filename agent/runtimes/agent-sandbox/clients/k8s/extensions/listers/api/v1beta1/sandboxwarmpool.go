...
type SandboxWarmPoolLister interface {
	...
	List(selector labels.Selector) (ret []*apiv1beta1.SandboxWarmPool, err error)
...
type sandboxWarmPoolLister struct {
	listers.ResourceIndexer[*apiv1beta1.SandboxWarmPool]
}
...
func NewSandboxWarmPoolLister(indexer cache.Indexer) SandboxWarmPoolLister {
	return &sandboxWarmPoolLister{listers.New[*apiv1beta1.SandboxWarmPool](indexer, apiv1beta1.Resource("sandboxwarmpool"))}
}

// SandboxWarmPools returns an object that can list and get SandboxWarmPools.
func (s *sandboxWarmPoolLister) SandboxWarmPools(namespace string) SandboxWarmPoolNamespaceLister {
	return sandboxWarmPoolNamespaceLister{listers.NewNamespaced[*apiv1beta1.SandboxWarmPool](s.ResourceIndexer, namespace)}
}
...
type SandboxWarmPoolNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*apiv1beta1.SandboxWarmPool, error)
