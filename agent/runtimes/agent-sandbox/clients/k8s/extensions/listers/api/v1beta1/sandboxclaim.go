...
type SandboxClaimLister interface {
	...
	List(selector labels.Selector) (ret []*apiv1beta1.SandboxClaim, err error)
...
type sandboxClaimLister struct {
	listers.ResourceIndexer[*apiv1beta1.SandboxClaim]
}
...
func NewSandboxClaimLister(indexer cache.Indexer) SandboxClaimLister {
	return &sandboxClaimLister{listers.New[*apiv1beta1.SandboxClaim](indexer, apiv1beta1.Resource("sandboxclaim"))}
}

// SandboxClaims returns an object that can list and get SandboxClaims.
func (s *sandboxClaimLister) SandboxClaims(namespace string) SandboxClaimNamespaceLister {
	return sandboxClaimNamespaceLister{listers.NewNamespaced[*apiv1beta1.SandboxClaim](s.ResourceIndexer, namespace)}
}
...
type SandboxClaimNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*apiv1beta1.SandboxClaim, error)
