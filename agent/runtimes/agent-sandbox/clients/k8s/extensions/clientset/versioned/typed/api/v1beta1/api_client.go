...
// ExtensionsV1beta1Client is used to interact with features provided by the extensions.agents.x-k8s.io group.
type ExtensionsV1beta1Client struct {
	restClient rest.Interface
}

func (c *ExtensionsV1beta1Client) SandboxClaims(namespace string) SandboxClaimInterface {
	return newSandboxClaims(c, namespace)
}

func (c *ExtensionsV1beta1Client) SandboxTemplates(namespace string) SandboxTemplateInterface {
	return newSandboxTemplates(c, namespace)
}

func (c *ExtensionsV1beta1Client) SandboxWarmPools(namespace string) SandboxWarmPoolInterface {
