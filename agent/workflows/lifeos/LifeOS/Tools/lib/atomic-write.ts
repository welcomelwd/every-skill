// Vendored copy of LIFEOS/PULSE/lib/atomic-write.ts. The install skill's Tools
// run PRE-install from the download directory, where no ../../../LIFEOS exists
// yet — every import must stay inside the skill (ImportCaseGate enforces this).
