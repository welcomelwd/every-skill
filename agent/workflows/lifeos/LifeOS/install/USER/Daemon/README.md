...
**What lives here:** Output from the Daemon system, which reads your TELOS, Knowledge, Projects, and other LifeOS sources and writes a curated public-facing profile. The Daemon decides what's safe to share and what stays private; the artifacts it produces (profile pages, current-focus snippets, reading lists) land here for review or publishing.
