 ...
 *
 * An early-2026 billing incident happened because LifeOS lacked a check like this:
...
function printUsage(): void {
  process.stderr.write(
    [
      "Usage:",
      "  bun LIFEOS/TOOLS/BillingPathAssertion.ts <oauth|api> <path-to-events.ndjson | ->",
      "",
