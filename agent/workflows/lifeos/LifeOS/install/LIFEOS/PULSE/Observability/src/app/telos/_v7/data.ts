...
export const TELOS = {
  ...
  team: [
    ...
    { id:'T2', name:'Sample Worker A', role:'Sample worker · 192.0.2.5',  kind:'agent',
      owns:['P4','P5'], avatar:'B', note:'Sample worker — operational tasks.' },
    { id:'T3', name:'Sample Worker B', role:'Sample worker · 192.0.2.11', kind:'agent',
      owns:[], avatar:'C', note:'Sample worker — fleet member.' },
    { id:'T4', name:'Sample Worker C', role:'Sample worker · 192.0.2.8',  kind:'agent',
  ...
  workNarrative: {
    summary: 'Sample work — 3 items in motion, 2 ready, 5 in inbox. Replace via /interview or by pointing WORK.REPO at your repo.',
    inProgress: 3,
    done: 4,
    ready: 2,
    inbox: 5,
  },
  currentStateNarrative: "Right now you're focused on shipping the sample dashboard, energy at 7/10, mood steady. This week's top intent is wiring real TELOS data through. Recent wins: the fixture renders end-to-end.",
  idealStateNarrative: 'Ideal state spans six dimensions: super healthy and active into your 90s, financially durable, calendar autonomy, creative output without scoring, relationships kept warm without ranking, and a yearly rhythm that includes off-grid time.',
  currentStateBullets: [
    { label: 'Focus', value: 'Shipping the sample dashboard' },
    { label: 'Energy', value: '7/10' },
    { label: 'Mood', value: 'Steady' },
    { label: 'Top intent', value: 'Wire real TELOS data through' },
    { label: 'Wins', value: 'Fixture renders end-to-end' },
  ],
  idealStateBullets: [
    { label: 'Health', value: 'Super healthy and active into your 90s' },
    { label: 'Finances', value: 'Financially durable, runway and posture' },
    { label: 'Freedom', value: 'Calendar autonomy, deep-work mornings' },
    { label: 'Creative', value: 'Output without scoring — drums, fiction, design' },
    { label: 'Relationships', value: 'Kept warm without ranking' },
    { label: 'Rhythms', value: 'Yearly anchors including off-grid time' },
  ],
  synthesisParagraph: "You're climbing toward your sample mission. The binding gap is the work-system integration. Strategies in flight: just-fucking-start, ship-properly. Replace via /interview to see your real synthesis.",
  synthesisSegments: [
    { kind: 'text', text: "Right now your work is pointed at " },
    { kind: 'mission', text: 'Sample Mission', id: 'M0' },
    { kind: 'text', text: ' — that\'s where everything lines up. The two gaps you keep running into are ' },
    { kind: 'problem', text: 'the Sample Problem', id: 'P0' },
    { kind: 'text', text: '. Which is exactly why you\'re sitting on ' },
    { kind: 'strategy', text: 'Just Fucking Start', id: 'S0' },
    { kind: 'text', text: ' as your strategy stack. ' },
    { kind: 'work', text: '3 threads' },
    { kind: 'text', text: ' in motion right now.' },
  ],
  recommendedNextAction: 'Run /interview to populate TELOS.md and watch this paragraph become real.',
