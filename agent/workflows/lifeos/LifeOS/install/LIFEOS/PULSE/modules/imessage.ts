...
${mcpStatusPromptLine(Object.keys(remoteMcp))}`,
  ...
  // scaffolding the model leaked despite the IMESSAGE_DIRECTIVE override.
  // Defense in depth — Layer 1 (directive) is primary; this is Layer 2.
  // Source: LIFEOS/PULSE/lib/strip-mode-scaffolding.ts.
  if (fullText && hasModeScaffolding(fullText)) {
