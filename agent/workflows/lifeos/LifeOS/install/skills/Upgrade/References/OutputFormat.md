# Upgrade — Canonical Output Format

**This is the single source of truth for Upgrade output structure.** Both `SKILL.md` and `Workflows/Upgrade.md` reference this file rather than inlining their own copies.
