...
curl -s -X POST http://localhost:31337/notify \
  ...
  -d '{"message": "Running the ResearchUpgrade workflow in the Upgrade skill to research upgrades"}' \
  > /dev/null 2>&1 &
```

Running the **ResearchUpgrade** workflow in the **Upgrade** skill to research upgrades...
