# LifeOS Pack Icon Workflow

**Generate 256x256 transparent PNG icons for LifeOS packs.**
...
Create consistent, professional icons for LifeOS packs following the established visual identity.
...
3. **Consistent style** - Match existing LifeOS pack icons
...
- [ ] **Consistent** - matches other LifeOS icons in style
