...
| [SQL Sanitizer](https://pypi.org/project/cpex-sql-sanitizer/) | Package | Detects risky SQL patterns and sanitizes/blocks dangerous statements (DROP, TRUNCATE, DELETE/UPDATE without WHERE) |
