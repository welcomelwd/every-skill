...
1. **PyPI Publishing** - Automatically publish to PyPI (using OIDC trusted publishing)
1. **Docker Image Build** - Build multi-platform Docker images
1. **GitHub Release Creation** - Automatically generate release notes (simplified version, without automatic changelog)
...
1. **Delete package from PyPI** (if published) - Requires admin privileges
1. **Delete Docker image tags from Docker Hub**
1. **Push new tag to re-release**
