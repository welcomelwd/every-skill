...
For general information about running Jupyter MCP Server as a Jupyter Server extension, see the [Jupyter Server Extension documentation](/mcp-transports/streamable-http-extension).
...
For general extension troubleshooting, see the [Jupyter Server Extension documentation](/mcp-transports/streamable-http-extension).
