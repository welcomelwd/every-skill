...
For advanced deployments with separate document and code sandbox servers:
...
Update with the actual configuration details from the [Jupyter MCP Server configuration](/mcp-transports/stdio#2-setup-jupyter-mcp-server).
