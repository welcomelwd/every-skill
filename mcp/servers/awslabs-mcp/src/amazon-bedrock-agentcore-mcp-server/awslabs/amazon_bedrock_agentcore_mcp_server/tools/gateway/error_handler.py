...
"""Error handling utilities for AgentCore Gateway tools."""
...
def handle_gateway_error(operation: str, error: Exception) -> ErrorResponse:
    ...
    Args:
        operation: Name of the operation that failed (e.g. 'CreateGateway').
