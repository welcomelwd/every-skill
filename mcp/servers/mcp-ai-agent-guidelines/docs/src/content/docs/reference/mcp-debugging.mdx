---
title: MCP Debugging
description: Black-box MCP verification using the Inspector CLI, smoke tests, and workspace tool naming conventions.
sidebar:
  label: MCP Debugging
  order: 4
---
...
- Do **not** disable authentication unless you fully understand the risk
