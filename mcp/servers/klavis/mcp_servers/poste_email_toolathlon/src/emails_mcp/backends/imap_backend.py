...
class IMAPBackend:
    ...
    def fetch_email(self, email_id: str, folder: str = "INBOX") -> EmailMessage:
        """Fetch single email by ID"""
        self.ensure_connected()
        
        # Always select the folder to ensure correct context
    ...
    def mark_as_important(self, email_id: str, folder: str = "INBOX") -> bool:
    ...
    def mark_as_not_important(self, email_id: str, folder: str = "INBOX") -> bool:
    ...
    def move_email(self, email_id: str, target_folder: str, source_folder: str = "INBOX") -> Optional[str]:
