---
title: "Gemini CLI"
description: "Connect Strata with Gemini CLI in minutes and supercharge your AI coding experience"
---
<img
...
<Steps>
  ...
  <Step title="Configure Gemini CLI">
    ...
    <img
      ...
      alt="Paste Strata Server URL in settings.json"
    />
  ...
  <Step title="Verify Tools Loading">
    ...
    <img
      ...
      alt="Strata Tools Loading in Gemini CLI"
    />
  ...
  <Step title="Start Using in Gemini CLI Chat">
    <img
      src="/images/knowledge-base/gemini_cli/step6.jpg"
      alt="Using Strata in Gemini CLI Chat"
    />
