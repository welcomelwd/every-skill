---
title: "Cursor"
description: "Connect Strata with Cursor IDE in minutes and supercharge your AI coding experience"
---
<img
...
<Steps>
    ...
    <Tabs>
      ...
      alt="Copy Strata Server URL"
       />
        ...
        <img
      src="/images/knowledge-base/cursor/step4.png"
      alt="Install Strata in Cursor"
       />
      </Tab>
      ...
      <Tab title="Via Code">
        ...
        2. Click **Add Custom MCP**
         ...
         <img
      src="/images/knowledge-base/cursor/step5.png"
      alt="MCP & Tools in Cursor Settings"
        />

        3. Paste the below code in **mcp.json** file (See Screenshot below)

         <img
      src="/images/knowledge-base/cursor/step6.png"
      alt="Paste Strata code in mcp.json"
        />
  ...
  <Step title="Verify Tools Loading">
    ...
    <img
      src="/images/knowledge-base/cursor/step7.png"
      alt="Strata Configuration in Cursor"
    />

    Tap on **klavis-strata** to view the list of tools loaded from Strata server.

    <img
      src="/images/knowledge-base/cursor/step8.png"
      alt="Strata Tools List in Cursor IDE"
    />
  ...
  <Step title="Start Using in Cursor Chat">
    <img
      src="/images/knowledge-base/cursor/step9.jpg"
      alt="Using Strata in Cursor Chat"
    />
