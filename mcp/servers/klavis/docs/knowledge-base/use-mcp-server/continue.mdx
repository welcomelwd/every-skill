---
title: "Continue"
description: "Connect Strata with Continue in minutes and supercharge your AI coding experience"
---
<img
...
<Steps>
  ...
  <Step title="Configure Continue">
    ...
    <img
      ...
      alt="MCP Server settings in Continue"
    />
  ...
  <Step title="Verify Tools Loading">
    ...
    <img
      src="/images/knowledge-base/continue/step8.png"
      alt="Strata Tool Configuration in Continue"
    />
  ...
  <Step title="Start Using in Continue Chat">
    <img
      src="/images/knowledge-base/continue/step9.jpg"
      alt="Using Strata Server in Continue Chat"
    />
    ...
    <Tip>
      🎯 Continue Chat automatically detects when to use **Strata** based on context - no need to specify explicitly!
    </Tip>
  </Step>
