...
namespace Microsoft.Mcp.Tests.Generated.Models
{
    ...
    public partial class UriRegexSanitizerBody
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="UriRegexSanitizerBody"/>. </summary>
        ...
        internal UriRegexSanitizerBody(string value, string regex, string groupForReplace, ApplyCondition condition, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            Regex = regex;
