...
namespace Microsoft.Mcp.Tests.Generated.Models
{
    ...
    public partial class BodyRegexSanitizerBody
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="BodyRegexSanitizerBody"/>. </summary>
        ...
        internal BodyRegexSanitizerBody(string value, string regex, string groupForReplace, ApplyCondition condition, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            Regex = regex;
