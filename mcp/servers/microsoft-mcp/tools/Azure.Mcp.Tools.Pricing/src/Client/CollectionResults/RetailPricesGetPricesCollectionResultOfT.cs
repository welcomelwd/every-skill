...
{
    internal partial class RetailPricesGetPricesCollectionResultOfT : CollectionResult<RetailPriceItem>
    {
        ...
        /// <summary> Initializes a new instance of RetailPricesGetPricesCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public RetailPricesGetPricesCollectionResultOfT(RetailPrices client, string currencyCode, string filter, string meterRegion, long? skip, RequestOptions options)
        {
            _client = client;
        ...
        protected override IEnumerable<RetailPriceItem> GetValuesFromPage(ClientResult page)
        {
            return ((RetailPricesResponse)page).Items;
        }
    }
}
