...
{
    internal partial class RetailPricesGetPricesAsyncCollectionResultOfT : AsyncCollectionResult<RetailPriceItem>
    {
        ...
        /// <summary> Initializes a new instance of RetailPricesGetPricesAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public RetailPricesGetPricesAsyncCollectionResultOfT(RetailPrices client, string currencyCode, string filter, string meterRegion, long? skip, RequestOptions options)
        {
            _client = client;
        ...
        protected override async IAsyncEnumerable<RetailPriceItem> GetValuesFromPageAsync(ClientResult page)
        {
            foreach (RetailPriceItem item in ((RetailPricesResponse)page).Items)
            {
                yield return item;
                await Task.Yield();
            }
