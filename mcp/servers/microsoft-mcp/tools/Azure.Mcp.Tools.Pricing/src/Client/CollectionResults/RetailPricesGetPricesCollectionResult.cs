...
{
    internal partial class RetailPricesGetPricesCollectionResult : CollectionResult
    {
        ...
        /// <summary> Initializes a new instance of RetailPricesGetPricesCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public RetailPricesGetPricesCollectionResult(RetailPrices client, string currencyCode, string filter, string meterRegion, long? skip, RequestOptions options)
        {
            _client = client;
