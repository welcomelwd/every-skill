...
public class CloudEndpointTriggerChangeDetectionCommandTests : SubscriptionCommandUnitTestsBase<CloudEndpointTriggerChangeDetectionCommand, IStorageSyncService>
{
    [Fact]
