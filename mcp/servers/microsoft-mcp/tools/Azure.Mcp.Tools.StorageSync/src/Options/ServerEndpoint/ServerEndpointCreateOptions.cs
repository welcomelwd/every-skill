...
/// </summary>
public sealed class ServerEndpointCreateOptions : ISubscriptionOption
{
    /// <summary>
    ...
    /// </summary>
    [Option(Description = "The resource ID of the registered server")]
    public required string ServerResourceId { get; set; }

    /// <summary>
    /// Gets or sets the server local path.
    /// </summary>
    [Option(Description = "The local folder path on the server for syncing")]
    public required string ServerLocalPath { get; set; }
