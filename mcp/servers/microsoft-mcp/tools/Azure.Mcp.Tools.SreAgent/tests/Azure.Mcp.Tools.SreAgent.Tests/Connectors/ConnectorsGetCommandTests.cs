...
public class ConnectorsGetCommandTests : SubscriptionCommandUnitTestsBase<ConnectorsGetCommand, ISreAgentService>
{
    ...
    public async Task ExecuteAsync_DeserializationValidation()
    {
        ...
        Assert.Equal(HttpStatusCode.OK, response.Status);
        var result = ValidateAndDeserializeResponse(response, SreAgentJsonContext.Default.ConnectorsGetCommandResult);
    ...
    public async Task BindOptions_BindsOptionsCorrectly()
    {
        ...
        Assert.Equal(HttpStatusCode.OK, response.Status);
        await Service.Received(1).GetConnectorAsync("sub", Arg.Any<string>(), "agent1", "connector1", null, Arg.Any<CancellationToken>());
    }
}
