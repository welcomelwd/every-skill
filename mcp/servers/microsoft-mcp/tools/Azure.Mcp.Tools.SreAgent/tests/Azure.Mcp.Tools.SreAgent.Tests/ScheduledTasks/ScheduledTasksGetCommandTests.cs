...
public class ScheduledTasksGetCommandTests : SubscriptionCommandUnitTestsBase<ScheduledTasksGetCommand, ISreAgentService>
{
    [Fact]
    ...
    public async Task BindOptions_BindsOptionsCorrectly()
    {
        ...
        Assert.Equal(HttpStatusCode.OK, response.Status);
        await Service.Received(1).GetScheduledTaskAsync(Arg.Any<string>(), "task1", "tenant1", Arg.Any<CancellationToken>());
    }
}
