...
public class ScheduledTasksDeleteCommandTests : SubscriptionCommandUnitTestsBase<ScheduledTasksDeleteCommand, ISreAgentService>
{
    [Fact]
    ...
    public async Task ExecuteAsync_ValidatesInputCorrectly(string args, bool shouldSucceed)
    {
        if (shouldSucceed)
        {
            ...
            Service.DeleteScheduledTaskAsync(
                Arg.Any<string>(),
                Arg.Any<string>(),
                Arg.Any<string?>(),
                Arg.Any<CancellationToken>())
