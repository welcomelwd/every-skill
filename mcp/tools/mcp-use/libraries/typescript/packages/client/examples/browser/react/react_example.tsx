...
const ReactExample: React.FC = () => {
  return (
    <div>
      ...
      >
        <h3>Local demo / OAuth servers</h3>
        <p>
          Defaults to the official-SDK demo at{" "}
          <code>http://127.0.0.1:3102/mcp</code> (start{" "}
          <code>examples/_demo-servers</code>). Override with{" "}
          <code>VITE_MCP_URL</code> (e.g. Linear). For OAuth servers,{" "}
          <code>preventAutoAuth</code> keeps the connection in{" "}
          <code>pending_auth</code> until you call <code>authenticate()</code>.
        </p>
      </div>
    </div>
  );
