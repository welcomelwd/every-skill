...
- Read the [`useViewState` API reference](/typescript/api-reference/react/useviewstate) for signatures, errors, and host behavior.
- Read the [`ModelContext` API reference](/typescript/api-reference/react/modelcontext) for nesting and imperative entries.
- Use [Interactivity](/typescript/mcp-apps/interactivity) for tool calls and follow-up messages.
