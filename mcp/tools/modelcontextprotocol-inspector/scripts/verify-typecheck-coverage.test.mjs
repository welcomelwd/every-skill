...
//
// The `tsc`-script and tsconfig-graph parsers this guard used to own moved to
// `lib/tsc-program.mjs` when `verify:dep-lockstep` began measuring the same
// programs (#1965); their cases moved to `lib/tsc-program.test.mjs` with them.
