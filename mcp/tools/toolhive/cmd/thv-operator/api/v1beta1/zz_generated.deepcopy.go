...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DelegateClientConfig) DeepCopyInto(out *DelegateClientConfig) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DelegateClientConfig.
func (in *DelegateClientConfig) DeepCopy() *DelegateClientConfig {
	if in == nil {
		return nil
	}
	out := new(DelegateClientConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *EmbeddedAuthServerConfig) DeepCopyInto(out *EmbeddedAuthServerConfig) {
	*out = *in
	...
	if in.DelegateClients != nil {
		in, out := &in.DelegateClients, &out.DelegateClients
		*out = make([]DelegateClientConfig, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.TrustedIssuers != nil {
		...
		*out = make([]TrustedIssuerConfig, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *JWTBearerGrantConfig) DeepCopyInto(out *JWTBearerGrantConfig) {
	*out = *in
	if in.MaxAssertionAge != nil {
		in, out := &in.MaxAssertionAge, &out.MaxAssertionAge
		*out = new(v1.Duration)
		**out = **in
	}
	if in.SubjectBindings != nil {
		in, out := &in.SubjectBindings, &out.SubjectBindings
		*out = make([]JWTBearerSubjectBinding, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new JWTBearerGrantConfig.
func (in *JWTBearerGrantConfig) DeepCopy() *JWTBearerGrantConfig {
	if in == nil {
		return nil
	}
	out := new(JWTBearerGrantConfig)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *JWTBearerSubjectBinding) DeepCopyInto(out *JWTBearerSubjectBinding) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new JWTBearerSubjectBinding.
func (in *JWTBearerSubjectBinding) DeepCopy() *JWTBearerSubjectBinding {
	if in == nil {
		return nil
	}
	out := new(JWTBearerSubjectBinding)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TrustedIssuerConfig) DeepCopyInto(out *TrustedIssuerConfig) {
	*out = *in
	...
	if in.AllowedDelegateClients != nil {
		in, out := &in.AllowedDelegateClients, &out.AllowedDelegateClients
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.JWTBearerGrant != nil {
		in, out := &in.JWTBearerGrant, &out.JWTBearerGrant
		*out = new(JWTBearerGrantConfig)
		(*in).DeepCopyInto(*out)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TrustedIssuerConfig.
func (in *TrustedIssuerConfig) DeepCopy() *TrustedIssuerConfig {
	if in == nil {
		return nil
	}
	out := new(TrustedIssuerConfig)
	in.DeepCopyInto(out)
	return out
}
