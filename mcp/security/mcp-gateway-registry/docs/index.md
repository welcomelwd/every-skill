...
| **OAuth 3-Legged Authentication** | [Watch 3LO Demo](https://github.com/user-attachments/assets/3585d258-66a1-458a-bc86-450f917f7cfd) |
...
The registry will be available at `http://localhost` with example MCP servers pre-configured.
