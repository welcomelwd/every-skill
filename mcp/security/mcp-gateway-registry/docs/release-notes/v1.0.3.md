...
**Documentation:** [Amazon Bedrock AgentCore Integration Guide](../agentcore.md)
...
- [Pre-built Images Documentation](../prebuilt-images.md)
...
**Documentation:** [Keycloak: Agent M2M & Operations Guide](../keycloak-agent-m2m.md) (renamed from keycloak-integration.md)
...
**Documentation:** [Observability Guide](../OBSERVABILITY.md)
...
**Documentation:** [Service Management Guide](../service-management.md)
...
- **New:** [Amazon Bedrock AgentCore Integration Guide](../agentcore.md)
- **Updated:** [Service Management Guide](../service-management.md)
- **Updated:** [Keycloak: Agent M2M & Operations Guide](../keycloak-agent-m2m.md) (renamed from keycloak-integration.md)
- **Updated:** [Observability Guide](../OBSERVABILITY.md)
- **New:** [macOS Setup Guide](../macos-setup-guide.md)
- **New:** [Remote Desktop Setup Guide](../remote-desktop-setup.md)
...
**Next Steps:**
1. Initialize Keycloak: Follow [Initial Environment Configuration](../complete-setup-guide.md#initialize-keycloak-configuration)
2. Create your first AI agent: [Create Your First AI Agent Account](../complete-setup-guide.md#create-your-first-ai-agent-account)
...
[Get Started](../installation.md) | [Documentation](../) | [Contribute](../../CONTRIBUTING.md)
