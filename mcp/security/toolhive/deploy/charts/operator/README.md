...
| operator.image | string | `"ghcr.io/stacklok/toolhive/operator:v0.43.0"` | Container image for the operator |
...
| operator.toolhiveRunnerImage | string | `"ghcr.io/stacklok/toolhive/proxyrunner:v0.43.0"` | Image to use for Toolhive runners |
| operator.vmcpImage | string | `"ghcr.io/stacklok/toolhive/vmcp:v0.43.0"` | Image to use for Virtual MCP Server (vMCP) deployments |
