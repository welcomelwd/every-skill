...
2. **Testen Sie die Gesundheitsendpunkte**:
   ```bash
   # Basic health check
...
1. **Konfigurieren Sie VS Code MCP**:
   ```json
   // .vscode/mcp.json
   {
       "servers": {
...
2. **Testen Sie im KI-Chat**:
   - Öffnen Sie den KI-Chat in VS Code
   - Geben Sie `#zava` ein und wählen Sie Ihren Server aus
   - Fragen Sie: "Welche Tabellen sind verfügbar?"
...
Fahren Sie mit **[Lab 06: Tool-Entwicklung](../06-Tools/README.md)** fort, um:
...
### FastMCP-Framework
- [FastMCP-Dokumentation](https://github.com/modelcontextprotocol/python-sdk) - Offizieller FastMCP-Leitfaden
- [MCP-Spezifikation](https://modelcontextprotocol.io/docs/) - Protokollspezifikation
- [Leitfaden zur Tool-Entwicklung](https://modelcontextprotocol.io/docs/tools/) - Erstellung von MCP-Tools

### Datenbankintegration
- [asyncpg-Dokumentation](https://magicstack.github.io/asyncpg/current/) - PostgreSQL-Async-Treiber
- [Best Practices für Connection-Pooling](https://www.postgresql.org/docs/current/runtime-config-connection.html) - PostgreSQL-Optimierung
- [Leitfaden zur Row Level Security](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - RLS-Implementierung

### FastAPI-Muster
- [FastAPI-Dokumentation](https://fastapi.tiangolo.com/) - Referenz für das Web-Framework
- [Dependency Injection](https://fastapi.tiangolo.com/tutorial/dependencies/) - FastAPI-Muster
- [Hintergrundaufgaben](https://fastapi.tiangolo.com/tutorial/background-tasks/) - Verwaltung von asynchronen Aufgaben

---

**Weiter**: Bereit, Ihre Tools zu erweitern? Fahren Sie fort mit [Lab 06: Tool-Entwicklung](../06-Tools/README.md)
