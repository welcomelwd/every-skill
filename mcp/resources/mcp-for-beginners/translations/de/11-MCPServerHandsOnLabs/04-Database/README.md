...
Dieses Lab behandelt ausführlich das PostgreSQL-Datenbankdesign für das Zava Retail-System. Sie lernen, ein umfassendes Einzelhandelsschema mit Vektorsuchfunktionen, Multi-Tenant-Datenmodellierung und Row Level Security (RLS) für Datenisolierung zu implementieren.

## Überblick

Die Datenbank ist die Grundlage unseres MCP-Servers und speichert Einzelhandelsdaten über mehrere Geschäfte hinweg, während sie strikte Datenisolierung gewährleistet. Wir verwenden PostgreSQL mit der pgvector-Erweiterung, um semantische Suchfunktionen zu ermöglichen, sodass Kunden Produkte mithilfe natürlicher Sprachabfragen finden können.

Unser Schema folgt modernen Multi-Tenant-Mustern, wobei Row Level Security sicherstellt, dass Benutzer nur auf Daten ihrer autorisierten Geschäfte zugreifen können. Dieser Ansatz bietet Sicherheit auf Unternehmensniveau und gleichzeitig optimale Leistung.

## Lernziele

Am Ende dieses Labs werden Sie in der Lage sein:

- **Skalierbare Multi-Tenant-Datenbankschemas** zu entwerfen  
- **PostgreSQL mit pgvector** für Vektorsuche zu implementieren  
- **Row Level Security** für Datenisolierung zu konfigurieren  
- **Realistische Testdaten** für die Entwicklung zu generieren  
- **Datenbankleistung** für Einzelhandelsanwendungen zu optimieren  
- **Backup- und Wiederherstellungsstrategien** umzusetzen  

## 🗃️ Datenbankarchitektur

### PostgreSQL mit pgvector

Unsere Datenbank nutzt die Enterprise-Funktionen von PostgreSQL in Kombination mit der pgvector-Erweiterung für KI-gestützte Suche:
...
Die Datenbank verwendet ein **Shared Database, Shared Schema**-Multi-Tenant-Modell mit Row Level Security:
...
### Produkte-Tabelle mit Kategorien
...
## 🔐 Einrichtung von Row Level Security
...
### Skript für realistische Testdaten
...
### Ansichten zur Abfrageoptimierung
...
✅ **Multi-Tenant-Datenbankdesign**: Row Level Security für sichere Datenisolierung implementiert haben  
✅ **Vektorsuchfunktionen**: pgvector für semantische Produktsuche konfiguriert haben  
✅ **Umfassendes Schema**: Produktionsreifes Einzelhandelsdatenbankschema erstellt haben  
✅ **Testdatengenerierung**: Realistische Testdaten für Entwicklung und Tests erstellt haben  
✅ **Leistungsoptimierung**: Indizes und Abfrageoptimierung konfiguriert haben  
✅ **Backup und Wiederherstellung**: Robuste Strategien zum Schutz von Daten etabliert haben  

## 🚀 Was kommt als Nächstes

Fahren Sie mit **[Lab 05: MCP Server Implementation](../05-MCP-Server/README.md)** fort, um:

- Den FastMCP-Server zu entwickeln, der mit dieser Datenbank verbunden ist  
- Datenbankabfragetools für das MCP-Protokoll zu implementieren  
- Semantische Suchfunktionen mithilfe der Embeddings hinzuzufügen  
- Connection-Pooling und Fehlerbehandlung zu konfigurieren  

## 📚 Zusätzliche Ressourcen

### PostgreSQL & pgvector
- [PostgreSQL-Dokumentation](https://www.postgresql.org/docs/) - Vollständige PostgreSQL-Referenz  
- [pgvector-Erweiterung](https://github.com/pgvector/pgvector) - Vektorsuche für PostgreSQL  
- [PostgreSQL-Leistungsoptimierung](https://wiki.postgresql.org/wiki/Performance_Optimization) - Best Practices zur Optimierung  

### Multi-Tenant-Architektur
- [Row Level Security](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - PostgreSQL RLS-Dokumentation  
- [Multi-Tenant-Datenarchitektur](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Azure Architektur-Muster  
- [Best Practices für Datenbanksicherheit](https://www.postgresql.org/docs/current/security.html) - PostgreSQL-Sicherheitsleitfaden  

### Vektordatenbanken
- [Grundlagen der Vektorsuche](https://www.pinecone.io/learn/vector-database/) - Einführung in Vektordatenbanken  
- [Embedding-Modelle](https://platform.openai.com/docs/guides/embeddings) - OpenAI-Dokumentation zu Embeddings  
- [HNSW-Algorithmus](https://arxiv.org/abs/1603.09320) - Hierarchische Navigable Small World Graphen  

---

**Vorher**: [Lab 03: Environment Setup](../03-Setup/README.md)  
**Nächstes**: [Lab 05: MCP Server Implementation](../05-MCP-Server/README.md)  
