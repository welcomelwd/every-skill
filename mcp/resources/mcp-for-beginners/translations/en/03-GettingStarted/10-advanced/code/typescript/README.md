...
Great, that means it's starting up correctly.

## Test the server

Test the capabilities with the following command:
...
You should now see this message showing that your validation works:
...
You should now see an "invalid arguments" error:
