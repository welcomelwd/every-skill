...
This should start the backend on `http://localhost:3001/mcp`. 
...
1. Make sure a chat window is open and type `get-faq`, you should see a result like so:
    ...
    ![Visual Studio Code MCP Apps](../../../../../../translated_images/en/vscode-ui.f2771dcfce25ca0f.webp)
...
- Run the host:
    ...
    ![App running](../../../../../../translated_images/en/mcp-app.50dd20a779bea32f.webp)
...
- Select "Call Tool" button and you should see the results like so:
    ...
    ![Tool result](../../../../../../translated_images/en/tool-result.cfec4814ce8e0146.webp)
