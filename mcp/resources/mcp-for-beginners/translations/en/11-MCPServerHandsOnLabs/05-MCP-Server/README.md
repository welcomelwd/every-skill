...
This hands-on lab walks you through the process of implementing a production-ready MCP server using the FastMCP framework. You'll design the core server structure, integrate a database, create tools for data access, and lay the groundwork for AI-driven retail analytics.

## Overview

The MCP server is the central component of our retail analytics solution. It serves as a bridge between AI assistants and the PostgreSQL database, enabling secure and intelligent access to business data through a standardized protocol.

This lab focuses on building a robust and scalable MCP server while adhering to enterprise-level patterns and best practices.

## Learning Objectives

By the end of this lab, you will be able to:

- **Build** a FastMCP server with a well-organized architecture
- **Implement** database integration with connection pooling and error handling
- **Create** MCP tools for database schema exploration and query execution
- **Configure** Row Level Security (RLS) context management
- **Add** health monitoring and observability features
- **Test** your MCP server implementation locally and within VS Code

## 📁 Project Structure

Let’s take a closer look at the organization of the MCP server:
...
Start by creating a robust configuration system:
...
- **Environment Variable Loading**: Automatic support for .env files
- **Type Safety**: Validation using dataclasses and type hints
- **Flexible Defaults**: Reasonable defaults for development environments
- **Validation**: Configuration validation with clear error messages
- **Security**: Sensitive values sourced exclusively from environment variables

## 🗄️ Database Integration Layer

### PostgreSQL Provider (`sales_analysis_postgres.py`)

Next, implement the database integration layer:
...
- **Connection Pooling**: Efficient resource management using asyncpg
- **RLS Integration**: Automatic setting of Row Level Security contexts
- **Schema Introspection**: Dynamic discovery of table schemas
- **Error Handling**: Comprehensive error management and logging
- **Query Formatting**: AI-friendly formatting of query results
- **Health Monitoring**: Checks for database connectivity and pool status

## 🔧 Main MCP Server Implementation

### FastMCP Server (`sales_analysis.py`)

Now, implement the main MCP server:
...
- **RLS Context Management**: Automatic extraction of user identity and context setting
- **Error Handling**: Comprehensive error management with user-friendly messages
- **Lifecycle Management**: Proper startup/shutdown with resource cleanup
- **Health Monitoring**: Built-in endpoints for health checks
...
✅ **Working MCP Server**: A FastMCP server with database integration  
✅ **Configuration Management**: A robust environment-based configuration system  
✅ **Database Layer**: PostgreSQL integration with connection pooling  
✅ **MCP Tools**: Tools for schema exploration and query execution  
...
Proceed to **[Lab 06: Tool Development](../06-Tools/README.md)** to:

- Expand your MCP toolset
...
- [Tool Development Guide](https://modelcontextprotocol.io/docs/tools/) - Guide to creating MCP tools
...
- [Background Tasks](https://fastapi.tiangolo.com/tutorial/background-tasks/) - Managing asynchronous tasks

---

**Next**: Ready to expand your tools? Proceed to [Lab 06: Tool Development](../06-Tools/README.md)
