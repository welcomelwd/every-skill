# Database Design og Skema

## 🎯 Hvad Denne Lab Dækker

Denne lab går i dybden med PostgreSQL-database designet for Zava Retail-systemet. Du lærer at implementere et omfattende detail-skema med vektorsøgningsfunktioner, multi-tenant datamodellering og Row Level Security (RLS) for dataisolering.

## Oversigt

Databasen er fundamentet for vores MCP-server og lagrer detaildata på tværs af flere butikker, samtidig med at den opretholder streng dataisolering. Vi bruger PostgreSQL med pgvector-udvidelsen for at muliggøre semantiske søgefunktioner, så kunder kan finde produkter ved hjælp af naturlige sprogforespørgsler.

Vores skema følger moderne multi-tenant mønstre med Row Level Security, der sikrer, at brugere kun kan få adgang til data fra deres autoriserede butikker. Denne tilgang giver sikkerhed på virksomhedsniveau, samtidig med at den opretholder optimal ydeevne.

## Læringsmål

Ved afslutningen af denne lab vil du være i stand til at:

- **Designe** skalerbare multi-tenant detail-database skemaer
- **Implementere** PostgreSQL med pgvector til vektorsøgning
- **Konfigurere** Row Level Security for dataisolering
- **Generere** realistiske testdata
- **Optimere** databaseydelsen til detailarbejdsbelastninger
- **Implementere** backup- og gendannelsesstrategier

## 🗃️ Databasearkitektur

### PostgreSQL med pgvector

Vores database udnytter PostgreSQL's enterprise-funktioner kombineret med pgvector-udvidelsen til AI-drevet søgning:
...
Databasen bruger en **delt database, delt skema** multi-tenancy model med Row Level Security:
...
## 🔍 Implementering af Vektorsøgning

### Produkt Embeddings Table
...
## 🔐 Opsætning af Row Level Security

### Database Roller og Tilladelser
...
### Script til Realistiske Testdata
...
### Views til Forespørgselsoptimering
...
✅ **Multi-Tenant Database Design**: Implementeret Row Level Security for sikker dataisolering  
✅ **Vektorsøgningsfunktioner**: Konfigureret pgvector til semantisk produktsøgning  
✅ **Omfattende Skema**: Oprettet produktionsklar detail-database skema  
✅ **Generering af Testdata**: Bygget realistiske testdata til udvikling og test  
✅ **Ydelsesoptimering**: Konfigureret indekser og forespørgselsoptimering  
✅ **Backup og Gendannelse**: Etableret robuste databeskyttelsesstrategier  

## 🚀 Hvad Er Næste Skridt

Fortsæt med **[Lab 05: MCP Server Implementation](../05-MCP-Server/README.md)** for at:

- Bygge FastMCP-serveren, der forbinder til denne database
- Implementere databaseforespørgselsværktøjer til MCP-protokollen
- Tilføje semantiske søgefunktioner ved hjælp af embeddings
- Konfigurere forbindelsespooling og fejlhåndtering

## 📚 Yderligere Ressourcer

### PostgreSQL & pgvector
- [PostgreSQL Dokumentation](https://www.postgresql.org/docs/) - Komplet PostgreSQL reference
- [pgvector Udvidelse](https://github.com/pgvector/pgvector) - Vektorsimilaritetssøgning for PostgreSQL
- [PostgreSQL Ydelsesoptimering](https://wiki.postgresql.org/wiki/Performance_Optimization) - Optimerings bedste praksis

### Multi-Tenant Arkitektur
- [Row Level Security](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - PostgreSQL RLS dokumentation
- [Multi-Tenant Data Arkitektur](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Azure arkitektur mønstre
- [Database Sikkerheds Bedste Praksis](https://www.postgresql.org/docs/current/security.html) - PostgreSQL sikkerhedsguide

### Vektordatabaser
- [Grundlæggende om Vektorsøgning](https://www.pinecone.io/learn/vector-database/) - Forståelse af vektordatabaser
- [Embedding Modeller](https://platform.openai.com/docs/guides/embeddings) - OpenAI embeddings dokumentation
- [HNSW Algoritme](https://arxiv.org/abs/1603.09320) - Hierarchical Navigable Small World grafer

---

**Forrige**: [Lab 03: Environment Setup](../03-Setup/README.md)  
**Næste**: [Lab 05: MCP Server Implementation](../05-MCP-Server/README.md)
