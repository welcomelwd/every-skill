# Дизайн на база данни и схема

## 🎯 Какво обхваща този лабораторен урок

Този лабораторен урок разглежда подробно дизайна на база данни PostgreSQL за системата Zava Retail. Ще научите как да внедрите цялостна схема за търговия на дребно с възможности за векторно търсене, моделиране на данни за множество наематели и Row Level Security (RLS) за изолация на данните.

## Обзор

Базата данни е основата на нашия MCP сървър, съхраняваща данни за търговия на дребно от множество магазини, като същевременно поддържа строга изолация на данните. Използваме PostgreSQL с разширението pgvector, за да активираме семантични възможности за търсене, позволявайки на клиентите да намират продукти чрез заявки на естествен език.

Нашата схема следва съвременни модели за множество наематели, като Row Level Security гарантира, че потребителите могат да достъпват само данни от своите упълномощени магазини. Този подход осигурява сигурност на корпоративно ниво, като същевременно поддържа оптимална производителност.

## Цели на обучението

До края на този лабораторен урок ще можете:

- **Да проектирате** мащабируеми схеми за база данни за множество наематели
- **Да внедрите** PostgreSQL с pgvector за векторно търсене
- **Да конфигурирате** Row Level Security за изолация на данните
- **Да генерирате** реалистични примерни данни за тестване
- **Да оптимизирате** производителността на базата данни за натоварвания в търговията на дребно
- **Да внедрите** стратегии за архивиране и възстановяване

## 🗃️ Архитектура на базата данни

### PostgreSQL с pgvector

Нашата база данни използва корпоративните функции на PostgreSQL, комбинирани с разширението pgvector за AI-задвижвано търсене:
...
### Архитектура за множество наематели

Базата данни използва модел за множество наематели **споделена база данни, споделена схема** с Row Level Security:
...
## 📊 Основен дизайн на схемата

### Таблица за магазини (Главен наемател)
...
### Таблица за продукти с категории
...
## 🔍 Внедряване на векторно търсене

### Таблица за продуктови вектори
...
## 🔐 Настройка на Row Level Security

### Роли и разрешения в базата данни
...
### Скрипт за реалистични тестови данни
...
### Изгледи за оптимизация на заявки
...
✅ **Дизайн на база данни за множество наематели**: Внедрена Row Level Security за сигурна изолация на данните  
✅ **Възможности за векторно търсене**: Конфигуриран pgvector за семантично търсене на продукти  
✅ **Цялостна схема**: Създадена база данни за търговия на дребно, готова за производство  
✅ **Генериране на примерни данни**: Създадени реалистични тестови данни за разработка и тестване  
✅ **Оптимизация на производителността**: Конфигурирани индекси и оптимизация на заявки  
✅ **Архивиране и възстановяване**: Установени надеждни стратегии за защита на данните  

## 🚀 Какво следва

Продължете с **[Лабораторен урок 05: Внедряване на MCP сървър](../05-MCP-Server/README.md)**, за да:

- Създадете FastMCP сървър, който се свързва с тази база данни
- Внедрите инструменти за заявки към базата данни за MCP протокола
- Добавите възможности за семантично търсене чрез векторите
- Конфигурирате пулове за връзки и обработка на грешки

## 📚 Допълнителни ресурси

### PostgreSQL & pgvector
- [Документация на PostgreSQL](https://www.postgresql.org/docs/) - Пълно ръководство за PostgreSQL
- [Разширение pgvector](https://github.com/pgvector/pgvector) - Векторно търсене за PostgreSQL
- [Оптимизация на производителността на PostgreSQL](https://wiki.postgresql.org/wiki/Performance_Optimization) - Най-добри практики за оптимизация

### Архитектура за множество наематели
- [Row Level Security](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - Документация за RLS в PostgreSQL
- [Архитектура за множество наематели](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Модели за архитектура в Azure
- [Най-добри практики за сигурност на базата данни](https://www.postgresql.org/docs/current/security.html) - Ръководство за сигурност в PostgreSQL

### Векторни бази данни
- [Основи на векторното търсене](https://www.pinecone.io/learn/vector-database/) - Разбиране на векторните бази данни
- [Модели за вектори](https://platform.openai.com/docs/guides/embeddings) - Документация за вектори на OpenAI
- [Алгоритъм HNSW](https://arxiv.org/abs/1603.09320) - Графи за малък свят с йерархична навигация

---

**Предишен**: [Лабораторен урок 03: Настройка на средата](../03-Setup/README.md)  
**Следващ**: [Лабораторен урок 05: Внедряване на MCP сървър](../05-MCP-Server/README.md)
