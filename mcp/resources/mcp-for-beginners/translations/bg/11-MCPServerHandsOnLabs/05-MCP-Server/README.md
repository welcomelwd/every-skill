...
Този практически урок ви води през процеса на създаване на готов за производство MCP сървър, използвайки рамката FastMCP. Ще изградите основната структура на сървъра, ще интегрирате база данни, ще създадете инструменти за достъп до данни и ще поставите основите за анализи на дребно, задвижвани от AI.

## Обзор

MCP сървърът е сърцето на нашето решение за анализи на дребно. Той действа като мост между AI асистентите и PostgreSQL базата данни, предоставяйки сигурен и интелигентен достъп до бизнес данни чрез стандартизиран протокол.

Този урок ви учи как да изградите надежден и мащабируем MCP сървър, следвайки корпоративни модели и добри практики.
...
- **Да внедрите** интеграция с база данни с пулове за връзки и обработка на грешки
- **Да създадете** MCP инструменти за инспекция на схемата на базата данни и изпълнение на заявки
- **Да конфигурирате** управление на контекста за сигурност на ниво редове (Row Level Security)
...
Нека внедрим слоя за интеграция с базата данни:
...
### Основни характеристики на слоя за база данни

- **Пулове за връзки**: Ефективно управление на ресурси с asyncpg
- **Интеграция с RLS**: Автоматично задаване на контекста за сигурност на ниво редове
...
- **Мониторинг на здравето**: Проверка на свързаността с базата данни и състоянието на пуловете

## 🔧 Основна имплементация на MCP сървъра

### FastMCP сървър (`sales_analysis.py`)

Сега нека внедрим основния MCP сървър:
...
- **Поддръжка за разработка**: Горещо презареждане и възможности за дебъгване
...
2. **Тествайте крайните точки за здраве**:
   ```bash
   # Basic health check
...
✅ **Слой за база данни**: PostgreSQL интеграция с пулове за връзки  
✅ **MCP инструменти**: Инструменти за инспекция на схемата и изпълнение на заявки  
✅ **Интеграция с RLS**: Управление на контекста за сигурност на ниво редове  
...
Продължете с **[Лабораторен урок 06: Разработка на инструменти](../06-Tools/README.md)**, за да:

- Разширите колекцията си от MCP инструменти
- Внедрите усъвършенствани модели за заявки
...
### Рамка FastMCP
- [Документация за FastMCP](https://github.com/modelcontextprotocol/python-sdk) - Официално ръководство за FastMCP
- [Спецификация на MCP](https://modelcontextprotocol.io/docs/) - Спецификация на протокола
...
- [Документация за asyncpg](https://magicstack.github.io/asyncpg/current/) - Асинхронен драйвер за PostgreSQL
- [Най-добри практики за пулове за връзки](https://www.postgresql.org/docs/current/runtime-config-connection.html) - Настройка на PostgreSQL
- [Ръководство за сигурност на ниво редове](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - Имплементация на RLS

### Модели за FastAPI
- [Документация за FastAPI](https://fastapi.tiangolo.com/) - Референция за уеб рамката
- [Инжектиране на зависимости](https://fastapi.tiangolo.com/tutorial/dependencies/) - Модели за FastAPI
- [Фонови задачи](https://fastapi.tiangolo.com/tutorial/background-tasks/) - Управление на асинхронни задачи

---

**Следващо**: Готови ли сте да разширите инструментите си? Продължете с [Лабораторен урок 06: Разработка на инструменти](../06-Tools/README.md)
