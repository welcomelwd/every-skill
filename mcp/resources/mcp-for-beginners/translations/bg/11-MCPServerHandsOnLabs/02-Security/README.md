# Сигурност и Мултитенантност

## 🎯 Какво обхваща този лабораторен урок

Този лабораторен урок предоставя изчерпателни насоки за внедряване на корпоративна сигурност и мултитенантност за MCP сървъри. Ще научите как да проектирате сигурни и съвместими системи, които защитават чувствителни данни от търговията на дребно, като същевременно позволяват гъвкави модели за достъп между множество наематели.

## Обзор

Сигурността е от първостепенно значение за приложенията в търговията на дребно, които обработват клиентски данни, информация за плащания и бизнес анализи. Този лабораторен урок обхваща цялостната архитектура на сигурността – от автентикация и авторизация до изолация на данни и мониторинг на съответствието.

Ние прилагаме стратегия за многослойна защита, комбинирайки услуги за идентичност на Azure, Row Level Security в PostgreSQL, контрол на приложението и цялостно регистриране на събития, за да създадем надеждна и съвместима платформа.

## Цели на обучението

До края на този лабораторен урок ще можете:

- **Да внедрите** корпоративна Row Level Security за изолация на данни между наематели
- **Да проектирате** сигурни модели за автентикация и авторизация с Azure
- **Да конфигурирате** цялостно регистриране на събития за изисквания за съответствие
- **Да приложите** стратегии за многослойна защита във всички слоеве на приложението
- **Да валидирате** внедренията за сигурност чрез систематично тестване
- **Да наблюдавате** събития, свързани със сигурността, и да реагирате на потенциални заплахи

## 🔐 Архитектура за сигурност при мултитенантност

### Преглед на слоевете за сигурност
...
### Модели за мултитенантност

Нашето внедрение използва модела **Споделена база данни, споделена схема** с Row Level Security:

**Предимства:**
- Рентабилно използване на ресурси
- Оптимизирана поддръжка и актуализации
- Силна изолация на данни чрез RLS
- Одитни следи, съвместими с изискванията

**Недостатъци:**
- Изисква внимателно проектиране на RLS политики
- Промените в схемата засягат всички наематели
- Необходими са надеждни процедури за архивиране и възстановяване

## 🛡️ Внедряване на Row Level Security
...
### Управление на контекста на магазина
...
### Цялостно регистриране на събития
...
### Прегледи за мониторинг на сигурността
...
### Мониторинг на събития, свързани със сигурността
...
### Автоматизирани тестове за сигурност
...
### Контролен списък за проникващо тестване
...
След завършване на този лабораторен урок, трябва да имате:

✅ **Сигурност при мултитенантност**: Внедрена Row Level Security за пълна изолация на данни  
✅ **Автентикация с Azure**: Интегриран Azure Entra ID с валидиране на JWT  
✅ **Авторизация на базата на роли**: Конфигуриран йерархичен модел за роли и разрешения  
✅ **Цялостно регистриране на събития**: Създадено проследяване и мониторинг на събития, свързани със сигурността  
✅ **Тестване на сигурността**: Внедрени автоматизирани тестове за валидиране на сигурността  
✅ **Мониторинг на заплахи**: Създадено откриване и известяване за събития в реално време  

## 🚀 Какво следва

Продължете с **[Лабораторен урок 03: Настройка на средата](../03-Setup/README.md)**, за да:

- Конфигурирате среди за разработка с най-добрите практики за сигурност
- Настроите Azure услуги за автентикация и мониторинг
- Внедрите сигурни връзки към бази данни и управление на тайни
- Валидирате конфигурациите за сигурност в среди за разработка

## 📚 Допълнителни ресурси

### Сигурност в Azure
- [Документация за Azure Entra ID](https://docs.microsoft.com/azure/active-directory/) - Пълно ръководство за платформата за идентичност
- [Azure Key Vault](https://docs.microsoft.com/azure/key-vault/) - Услуга за управление на тайни
- [Най-добри практики за сигурност в Azure](https://docs.microsoft.com/azure/security/fundamentals/best-practices-and-patterns) - Насоки за сигурност

### Сигурност на бази данни
- [PostgreSQL Row Level Security](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - Официална документация за RLS
- [Контролен списък за сигурност на бази данни](https://www.postgresql.org/docs/current/security.html) - Ръководство за сигурност на PostgreSQL
- [Модели за мултитенантност на бази данни](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Архитектурни модели

### Тестване на сигурността
- [Ръководство за тестване на OWASP](https://owasp.org/www-project-web-security-testing-guide/) - Изчерпателно ръководство за тестване на сигурността
- [Най-добри практики за сигурност на JWT](https://tools.ietf.org/html/rfc8725) - Съображения за сигурност на JWT
- [Тестване на сигурността на API](https://owasp.org/www-project-api-security/) - Тестване, специфично за API

---

**Предишен**: [Лабораторен урок 01: Основни концепции за архитектура](../01-Architecture/README.md)  
**Следващ**: [Лабораторен урок 03: Настройка на средата](../03-Setup/README.md)
