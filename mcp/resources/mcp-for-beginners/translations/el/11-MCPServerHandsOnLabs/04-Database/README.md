# Σχεδιασμός Βάσης Δεδομένων και Σχήμα

## 🎯 Τι Καλύπτει Αυτό το Εργαστήριο

Αυτό το εργαστήριο εξετάζει σε βάθος τον σχεδιασμό της βάσης δεδομένων PostgreSQL για το σύστημα Zava Retail. Θα μάθετε να υλοποιείτε ένα ολοκληρωμένο σχήμα λιανικής πώλησης με δυνατότητες αναζήτησης μέσω διανυσμάτων, μοντελοποίηση δεδομένων πολλαπλών ενοικιαστών και Row Level Security (RLS) για απομόνωση δεδομένων.

## Επισκόπηση

Η βάση δεδομένων αποτελεί τη θεμελιώδη δομή του MCP server, αποθηκεύοντας δεδομένα λιανικής πώλησης από πολλά καταστήματα, ενώ διατηρεί αυστηρή απομόνωση δεδομένων. Χρησιμοποιούμε PostgreSQL με την επέκταση pgvector για να ενεργοποιήσουμε δυνατότητες σημασιολογικής αναζήτησης, επιτρέποντας στους πελάτες να βρίσκουν προϊόντα μέσω ερωτημάτων φυσικής γλώσσας.

Το σχήμα μας ακολουθεί σύγχρονα πρότυπα πολλαπλών ενοικιαστών με Row Level Security, εξασφαλίζοντας ότι οι χρήστες μπορούν να έχουν πρόσβαση μόνο στα δεδομένα των εξουσιοδοτημένων καταστημάτων τους. Αυτή η προσέγγιση παρέχει ασφάλεια επιπέδου επιχείρησης, διατηρώντας παράλληλα βέλτιστη απόδοση.

## Στόχοι Μάθησης

Μέχρι το τέλος αυτού του εργαστηρίου, θα μπορείτε να:

- **Σχεδιάσετε** κλιμακούμενα σχήματα βάσης δεδομένων λιανικής πώλησης πολλαπλών ενοικιαστών
- **Υλοποιήσετε** PostgreSQL με pgvector για αναζήτηση μέσω διανυσμάτων
- **Ρυθμίσετε** Row Level Security για απομόνωση δεδομένων
- **Δημιουργήσετε** ρεαλιστικά δείγματα δεδομένων για δοκιμές
- **Βελτιστοποιήσετε** την απόδοση της βάσης δεδομένων για φόρτους εργασίας λιανικής πώλησης
- **Υλοποιήσετε** στρατηγικές δημιουργίας αντιγράφων ασφαλείας και ανάκτησης

## 🗃️ Αρχιτεκτονική Βάσης Δεδομένων

### PostgreSQL με pgvector

Η βάση δεδομένων μας αξιοποιεί τις επιχειρησιακές δυνατότητες του PostgreSQL σε συνδυασμό με την επέκταση pgvector για αναζήτηση με τεχνητή νοημοσύνη:
...
Η βάση δεδομένων χρησιμοποιεί ένα μοντέλο πολλαπλών ενοικιαστών **κοινής βάσης δεδομένων, κοινό σχήμα** με Row Level Security:
...
## 📊 Σχεδιασμός Κεντρικού Σχήματος

### Πίνακας Καταστημάτων (Tenant Master)
...
### Πίνακας Προϊόντων με Κατηγορίες
...
## 🔍 Υλοποίηση Αναζήτησης μέσω Διανυσμάτων

### Πίνακας Ενσωματώσεων Προϊόντων
...
### Συναρτήσεις Αναζήτησης μέσω Διανυσμάτων
...
## 🔐 Ρύθμιση Row Level Security

### Ρόλοι και Δικαιώματα Βάσης Δεδομένων
...
### Σενάριο Ρεαλιστικών Δεδομένων Δοκιμής
...
### Προβολές Βελτιστοποίησης Ερωτημάτων
...
✅ **Σχεδιασμό Βάσης Δεδομένων Πολλαπλών Ενοικιαστών**: Υλοποιήσει Row Level Security για ασφαλή απομόνωση δεδομένων  
✅ **Δυνατότητες Αναζήτησης μέσω Διανυσμάτων**: Ρυθμίσει το pgvector για σημασιολογική αναζήτηση προϊόντων  
✅ **Ολοκληρωμένο Σχήμα**: Δημιουργήσει σχήμα βάσης δεδομένων λιανικής πώλησης έτοιμο για παραγωγή  
✅ **Δημιουργία Δεδομένων Δοκιμής**: Κατασκευάσει ρεαλιστικά δεδομένα δοκιμής για ανάπτυξη και δοκιμές  
✅ **Βελτιστοποίηση Απόδοσης**: Ρυθμίσει ευρετήρια και βελτιστοποίηση ερωτημάτων  
✅ **Δημιουργία Αντιγράφων Ασφαλείας και Ανάκτηση**: Καθιερώσει ισχυρές στρατηγικές προστασίας δεδομένων  

## 🚀 Τι Ακολουθεί

Συνεχίστε με **[Εργαστήριο 05: Υλοποίηση MCP Server](../05-MCP-Server/README.md)** για να:

- Δημιουργήσετε τον FastMCP server που συνδέεται με αυτή τη βάση δεδομένων
- Υλοποιήσετε εργαλεία ερωτημάτων βάσης δεδομένων για το πρωτόκολλο MCP
- Προσθέσετε δυνατότητες σημασιολογικής αναζήτησης χρησιμοποιώντας τις ενσωματώσεις
- Ρυθμίσετε pooling συνδέσεων και χειρισμό σφαλμάτων

## 📚 Πρόσθετοι Πόροι

### PostgreSQL & pgvector
- [Τεκμηρίωση PostgreSQL](https://www.postgresql.org/docs/) - Πλήρης αναφορά PostgreSQL
- [Επέκταση pgvector](https://github.com/pgvector/pgvector) - Αναζήτηση ομοιότητας διανυσμάτων για PostgreSQL
- [Βελτιστοποίηση Απόδοσης PostgreSQL](https://wiki.postgresql.org/wiki/Performance_Optimization) - Βέλτιστες πρακτικές βελτιστοποίησης

### Αρχιτεκτονική Πολλαπλών Ενοικιαστών
- [Row Level Security](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - Τεκμηρίωση RLS PostgreSQL
- [Αρχιτεκτονική Δεδομένων Πολλαπλών Ενοικιαστών](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Πρότυπα αρχιτεκτονικής Azure
- [Βέλτιστες Πρακτικές Ασφάλειας Βάσης Δεδομένων](https://www.postgresql.org/docs/current/security.html) - Οδηγός ασφάλειας PostgreSQL

### Βάσεις Δεδομένων Διανυσμάτων
- [Βασικά Στοιχεία Αναζήτησης μέσω Διανυσμάτων](https://www.pinecone.io/learn/vector-database/) - Κατανόηση βάσεων δεδομένων διανυσμάτων
- [Μοντέλα Ενσωμάτωσης](https://platform.openai.com/docs/guides/embeddings) - Τεκμηρίωση ενσωματώσεων OpenAI
- [Αλγόριθμος HNSW](https://arxiv.org/abs/1603.09320) - Γραφήματα Hierarchical Navigable Small World

---

**Προηγούμενο**: [Εργαστήριο 03: Ρύθμιση Περιβάλλοντος](../03-Setup/README.md)  
**Επόμενο**: [Εργαστήριο 05: Υλοποίηση MCP Server](../05-MCP-Server/README.md)
