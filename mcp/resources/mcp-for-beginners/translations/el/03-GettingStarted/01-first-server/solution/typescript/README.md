...
- πηγαίνετε στους πόρους και στο πρότυπο πόρων και καλέστε "greeting". Πληκτρολογήστε ένα όνομα και θα πρέπει να δείτε έναν χαιρετισμό με το όνομα που δώσατε.

### Δοκιμή σε λειτουργία CLI

Ο επιθεωρητής που εκτελέσατε είναι στην πραγματικότητα μια εφαρμογή Node.js και το `mcp dev` είναι ένα wrapper γύρω από αυτήν.
...
Αυτό θα καταγράψει όλα τα διαθέσιμα εργαλεία στον server. Θα πρέπει να δείτε την παρακάτω έξοδο:
