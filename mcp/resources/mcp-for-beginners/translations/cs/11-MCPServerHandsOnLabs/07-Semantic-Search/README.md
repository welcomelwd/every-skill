...
Tento workshop poskytuje komplexní návod na implementaci funkcí sémantického vyhledávání pomocí Azure OpenAI embeddings a rozšíření pgvector pro PostgreSQL. Naučíte se vytvářet AI-poháněné vyhledávání produktů, které rozumí dotazům v přirozeném jazyce a poskytuje relevantní výsledky na základě sémantické podobnosti.

## Přehled

Tradiční vyhledávání založené na klíčových slovech často nedokáže zachytit záměr uživatele a sémantický význam. Sémantické vyhledávání pomocí vektorových embeddings umožňuje přirozené jazykové dotazy, jako například „pohodlné běžecké boty do deštivého počasí“, najít relevantní produkty, i když se tato přesná slova neobjevují v popisech produktů.

Naše implementace kombinuje výkonné modely embeddings od Azure OpenAI s rozšířením pgvector pro PostgreSQL, aby vytvořila vysoce výkonný, škálovatelný systém sémantického vyhledávání, který zlepšuje maloobchodní zkušenost díky inteligentnímu objevování produktů.

## Cíle učení

Na konci tohoto workshopu budete schopni:

- **Integrovat** modely embeddings od Azure OpenAI pro vektorizaci textu  
- **Implementovat** pgvector pro efektivní operace vyhledávání podle podobnosti  
- **Vytvořit** nástroje sémantického vyhledávání pro dotazy na produkty v přirozeném jazyce  
- **Navrhnout** hybridní vyhledávání kombinující tradiční a vektorové vyhledávání  
- **Optimalizovat** vektorové dotazy pro výkon v produkčním prostředí  
- **Navrhnout** doporučovací systémy pomocí podobnosti embeddings  

## 🧠 Architektura sémantického vyhledávání

### Pipeline pro vyhledávání podle vektorů
...
### Strategie generování embeddings
...
## 🔍 Generování embeddings pro produkty

### Automatizovaný pipeline pro embeddings
...
## 🔎 Nástroje sémantického vyhledávání

### Nástroj pro sémantické vyhledávání produktů
...
### Doporučovací engine pro produkty
...
### Optimalizace dotazů na vektory
...
### Strategie cache pro embeddings
...
✅ **Integraci Azure OpenAI**: Kompletní generování embeddings s cache a optimalizací  
✅ **Implementaci vyhledávání podle vektorů**: Produkčně připravené sémantické vyhledávání s pgvector  
✅ **Schopnosti hybridního vyhledávání**: Kombinace klíčového a sémantického vyhledávání pro optimální výsledky  
✅ **Doporučovací systémy**: AI-poháněné doporučování produktů pomocí podobnosti  
✅ **Optimalizaci výkonu**: Optimalizace indexů vektorů a inteligentní cache  
✅ **Škálovatelnou architekturu**: Sémantické vyhledávání připravené pro podnikové prostředí  

## 🚀 Co dál

Pokračujte s **[Workshopem 08: Testování a ladění](../08-Testing/README.md)**, kde se naučíte:

- Implementovat komplexní strategie testování pro sémantické vyhledávání  
- Ladit problémy s výkonem vyhledávání podle vektorů  
- Validovat kvalitu a relevanci embeddings  
- Testovat přesnost doporučovacího systému  

## 📚 Další zdroje

### Azure OpenAI  
- [Dokumentace služby Azure OpenAI](https://docs.microsoft.com/azure/cognitive-services/openai/) – Kompletní průvodce službou  
- [Referenční dokumentace API pro embeddings](https://platform.openai.com/docs/api-reference/embeddings) – Dokumentace API  
- [Nejlepší postupy pro embeddings](https://platform.openai.com/docs/guides/embeddings/what-are-embeddings) – Návod k implementaci  

### Vektorové databáze  
- [Dokumentace pgvector](https://github.com/pgvector/pgvector) – Rozšíření PostgreSQL pro vektory  
- [Optimalizace vyhledávání podle vektorů](https://www.pinecone.io/learn/vector-search-optimization/) – Ladění výkonu  
- [Algoritmus HNSW](https://arxiv.org/abs/1603.09320) – Hierarchické navigovatelné malé světy  

### Sémantické vyhledávání  
- [Základy informačního vyhledávání](https://nlp.stanford.edu/IR-book/) – Učebnice Stanford IR  
- [Nejlepší postupy pro vyhledávání podle vektorů](https://weaviate.io/blog/vector-search-best-practices) – Vzory implementace  
- [Strategie hybridního vyhledávání](https://blog.vespa.ai/hybrid-search/) – Kombinace různých přístupů k vyhledávání  

---

**Předchozí**: [Workshop 06: Vývoj nástrojů](../06-Tools/README.md)  
**Další**: [Workshop 08: Testování a ladění](../08-Testing/README.md)  
