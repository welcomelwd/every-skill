# Návrh databáze a schéma

## 🎯 Co tento lab pokrývá

Tento lab se podrobně zabývá návrhem databáze PostgreSQL pro systém Zava Retail. Naučíte se implementovat komplexní maloobchodní schéma s možnostmi vektorového vyhledávání, modelování dat pro více nájemců a Row Level Security (RLS) pro izolaci dat.

## Přehled

Databáze je základem našeho MCP serveru, ukládá maloobchodní data napříč více obchody a zároveň zajišťuje přísnou izolaci dat. Používáme PostgreSQL s rozšířením pgvector, které umožňuje sémantické vyhledávání, což zákazníkům umožňuje hledat produkty pomocí přirozeného jazyka.

Naše schéma sleduje moderní vzory pro více nájemců s Row Level Security, která zajišťuje, že uživatelé mohou přistupovat pouze k datům ze svých autorizovaných obchodů. Tento přístup poskytuje bezpečnost na úrovni podniku a zároveň udržuje optimální výkon.

## Cíle učení

Na konci tohoto labu budete schopni:

- **Navrhnout** škálovatelná maloobchodní schémata databází pro více nájemců  
- **Implementovat** PostgreSQL s pgvector pro vektorové vyhledávání  
- **Nakonfigurovat** Row Level Security pro izolaci dat  
- **Generovat** realistická testovací data  
- **Optimalizovat** výkon databáze pro maloobchodní pracovní zátěže  
- **Implementovat** strategie zálohování a obnovy  

## 🗃️ Architektura databáze

### PostgreSQL s pgvector

Naše databáze využívá podnikové funkce PostgreSQL v kombinaci s rozšířením pgvector pro vyhledávání poháněné AI:
...
### Architektura pro více nájemců

Databáze používá model **sdílené databáze, sdíleného schématu** s Row Level Security:
...
## 📊 Návrh základního schématu

### Tabulka Stores (hlavní tabulka nájemců)
...
### Tabulka Products s kategoriemi
...
### Funkce pro vektorové vyhledávání
...
## 🔐 Nastavení Row Level Security

### Role a oprávnění v databázi
...
### Skript pro realistická testovací data
...
### Pohledy pro optimalizaci dotazů
...
✅ **Návrh databáze pro více nájemců**: Implementováno Row Level Security pro bezpečnou izolaci dat  
✅ **Možnosti vektorového vyhledávání**: Nakonfigurován pgvector pro sémantické vyhledávání produktů  
✅ **Komplexní schéma**: Vytvořeno produkčně připravené maloobchodní schéma databáze  
✅ **Generování testovacích dat**: Vytvořena realistická testovací data pro vývoj a testování  
✅ **Optimalizace výkonu**: Nakonfigurovány indexy a optimalizace dotazů  
✅ **Zálohování a obnova**: Zavedena robustní strategie ochrany dat  

## 🚀 Co dál

Pokračujte s **[Lab 05: Implementace MCP serveru](../05-MCP-Server/README.md)**, kde:

- Vytvoříte server FastMCP, který se připojuje k této databázi  
- Implementujete nástroje pro dotazování databáze v rámci protokolu MCP  
- Přidáte možnosti sémantického vyhledávání pomocí embeddingů  
- Nakonfigurujete pooling připojení a zpracování chyb  

## 📚 Další zdroje

### PostgreSQL & pgvector
- [Dokumentace PostgreSQL](https://www.postgresql.org/docs/) - Kompletní referenční příručka PostgreSQL  
- [Rozšíření pgvector](https://github.com/pgvector/pgvector) - Vektorové vyhledávání podobnosti pro PostgreSQL  
- [Optimalizace výkonu PostgreSQL](https://wiki.postgresql.org/wiki/Performance_Optimization) - Nejlepší postupy pro optimalizaci  

### Architektura pro více nájemců
- [Row Level Security](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - Dokumentace PostgreSQL RLS  
- [Architektura dat pro více nájemců](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Vzory architektury Azure  
- [Nejlepší postupy zabezpečení databáze](https://www.postgresql.org/docs/current/security.html) - Průvodce zabezpečením PostgreSQL  

### Vektorové databáze
- [Základy vektorového vyhledávání](https://www.pinecone.io/learn/vector-database/) - Pochopení vektorových databází  
- [Embedding modely](https://platform.openai.com/docs/guides/embeddings) - Dokumentace embeddingů OpenAI  
- [Algoritmus HNSW](https://arxiv.org/abs/1603.09320) - Hierarchické navigovatelné malé světy  

---

**Předchozí**: [Lab 03: Nastavení prostředí](../03-Setup/README.md)  
**Další**: [Lab 05: Implementace MCP serveru](../05-MCP-Server/README.md)
