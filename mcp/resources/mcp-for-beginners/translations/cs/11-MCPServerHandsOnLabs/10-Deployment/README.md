...
Tento lab poskytuje komplexní návod, jak nasadit váš MCP retail server do produkčního prostředí pomocí moderních přístupů k containerizaci a cloud-native technologiím. Naučíte se nasazovat škálovatelné, zabezpečené a monitorované MCP servery, které zvládnou podnikové zátěže.

## Přehled

Produkční nasazení MCP serverů vyžaduje pečlivé zvážení containerizace, orchestrace, zabezpečení, škálovatelnosti a monitorování. Tento lab se zaměřuje na nasazení do Azure Container Apps s PostgreSQL Flexible Server, implementaci CI/CD pipeline a konfiguraci automatického škálování pro proměnlivé zátěže.

Strategie nasazení sahají od jednoduchých nasazení s jedním kontejnerem pro vývoj až po sofistikovaná produkční prostředí s více regiony, automatickým škálováním, komplexním monitorováním a bezpečnostními funkcemi.

## Cíle učení

Na konci tohoto labu budete schopni:

- **Containerizovat** MCP servery pomocí Dockeru s multi-stage buildy
- **Nasadit** do Azure Container Apps s bezpečnou sítí
- **Konfigurovat** produkční PostgreSQL s vysokou dostupností
- **Implementovat** CI/CD pipeline pro automatizované nasazení
- **Škálovat** aplikace automaticky na základě poptávky
- **Monitorovat** produkční nasazení pomocí komplexní observability

## 🐳 Containerizace pomocí Dockeru
...
## ☁️ Nasazení do Azure Container Apps
...
## 🔐 Konfigurace zabezpečení pro produkci
...
✅ **Strategii containerizace**: Produkčně připravené Docker kontejnery s bezpečnostním zpevněním  
✅ **Cloudové nasazení**: Azure Container Apps s automatickým škálováním a monitorováním  
✅ **Nasazení databáze**: PostgreSQL Flexible Server s vysokou dostupností  
✅ **CI/CD pipeline**: Automatizované workflow pro testování, build a nasazení  
✅ **Monitorování výkonu**: Komplexní sběr metrik a upozornění  
✅ **Konfiguraci zabezpečení**: Produkční bezpečnostní politiky a izolaci sítě  

## 🚀 Co dál

Pokračujte s **[Lab 11: Monitorování a observability](../11-Monitoring/README.md)**, kde se naučíte:

- Nastavit komplexní monitorování pomocí Application Insights
- Konfigurovat strukturované logování a distribuované trasování
- Implementovat upozornění a automatizované reakční systémy
- Monitorovat obchodní metriky a výkonnostní KPI

## 📚 Další zdroje

### Technologie containerů
- [Nejlepší praktiky Dockeru](https://docs.docker.com/develop/dev-best-practices/) - Oficiální doporučení Dockeru
- [Azure Container Apps](https://docs.microsoft.com/en-us/azure/container-apps/) - Dokumentace Azure Container Apps
- [Dokumentace Kubernetes](https://kubernetes.io/docs/) - Oficiální dokumentace Kubernetes

### CI/CD a DevOps
- [GitHub Actions](https://docs.github.com/en/actions) - Dokumentace GitHub Actions
- [Azure DevOps](https://docs.microsoft.com/en-us/azure/devops/) - Služby Azure DevOps
- [Infrastruktura jako kód](https://docs.microsoft.com/en-us/azure/azure-resource-manager/bicep/) - Dokumentace Azure Bicep

### Zabezpečení a monitorování
- [Azure Security Center](https://docs.microsoft.com/en-us/azure/security-center/) - Doporučení pro zabezpečení Azure
- [Zabezpečení kontejnerů](https://kubernetes.io/docs/concepts/security/) - Koncepty zabezpečení Kubernetes
- [Application Insights](https://docs.microsoft.com/en-us/azure/azure-monitor/app/app-insights-overview) - Přehled Azure Application Insights

---

**Předchozí**: [Lab 09: Integrace VS Code](../09-VS-Code/README.md)  
**Další**: [Lab 11: Monitorování a observability](../11-Monitoring/README.md)
