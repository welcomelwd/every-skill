# Zabezpečení a Multi-Tenancy

## 🎯 Co tento lab pokrývá

Tento lab poskytuje komplexní návod na implementaci zabezpečení na podnikové úrovni a multi-tenancy pro MCP servery. Naučíte se navrhovat bezpečné a vyhovující systémy, které chrání citlivá data z oblasti maloobchodu a zároveň umožňují flexibilní přístupové vzory napříč různými nájemci.

## Přehled

Zabezpečení je klíčové v maloobchodních aplikacích, které pracují s daty zákazníků, platebními informacemi a obchodními analýzami. Tento lab pokrývá kompletní architekturu zabezpečení od autentizace a autorizace po izolaci dat a monitorování souladu.

Implementujeme strategii hloubkové obrany, která kombinuje služby identity Azure, Row Level Security v PostgreSQL, kontrolu na úrovni aplikace a komplexní auditní logování, abychom vytvořili robustní a vyhovující platformu.

## Cíle učení

Na konci tohoto labu budete schopni:

- **Implementovat** Row Level Security na podnikové úrovni pro izolaci dat mezi nájemci
- **Navrhnout** bezpečné vzory autentizace a autorizace pomocí Azure
- **Konfigurovat** komplexní auditní logování pro požadavky na soulad
- **Aplikovat** strategie hloubkové obrany napříč všemi vrstvami aplikace
- **Validovat** implementace zabezpečení prostřednictvím systematického testování
- **Monitorovat** bezpečnostní události a reagovat na potenciální hrozby

## 🔐 Architektura zabezpečení pro multi-tenancy

### Přehled vrstev zabezpečení
...
Naše implementace využívá model **Sdílená databáze, sdílené schéma** s Row Level Security:

**Výhody:**
- Nákladově efektivní využití zdrojů
- Zjednodušená údržba a aktualizace
- Silná izolace dat díky RLS
- Auditní stopy přátelské k souladu

**Nevýhody:**
- Vyžaduje pečlivý návrh politik RLS
- Změny schématu ovlivňují všechny nájemce
- Nutnost robustních postupů zálohování/obnovy

## 🛡️ Implementace Row Level Security
...
### Pohledy pro monitorování zabezpečení
...
### Kontrolní seznam pro penetrační testování
...
✅ **Zabezpečení pro multi-tenancy**: Implementováno Row Level Security pro kompletní izolaci dat  
✅ **Autentizace Azure**: Integrované Azure Entra ID s validací JWT  
✅ **Autorizace na základě rolí**: Konfigurován hierarchický systém rolí a oprávnění  
✅ **Komplexní auditní logování**: Zavedeno sledování a monitorování bezpečnostních událostí  
✅ **Testování zabezpečení**: Implementovány automatizované testy validace zabezpečení  
✅ **Monitorování hrozeb**: Vytvořeno detekování bezpečnostních událostí v reálném čase a upozornění  

## 🚀 Co dál

Pokračujte s **[Lab 03: Nastavení prostředí](../03-Setup/README.md)**, kde:

- Nakonfigurujete vývojová prostředí s nejlepšími postupy zabezpečení
- Nastavíte služby Azure pro autentizaci a monitorování
- Implementujete bezpečné připojení k databázi a správu tajných klíčů
- Validujete konfigurace zabezpečení ve vývojových prostředích

## 📚 Další zdroje

### Zabezpečení Azure
- [Dokumentace Azure Entra ID](https://docs.microsoft.com/azure/active-directory/) - Kompletní průvodce platformou identity
- [Azure Key Vault](https://docs.microsoft.com/azure/key-vault/) - Služba pro správu tajných klíčů
- [Nejlepší postupy zabezpečení Azure](https://docs.microsoft.com/azure/security/fundamentals/best-practices-and-patterns) - Pokyny k zabezpečení

### Zabezpečení databáze
- [PostgreSQL Row Level Security](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - Oficiální dokumentace RLS
- [Kontrolní seznam zabezpečení databáze](https://www.postgresql.org/docs/current/security.html) - Průvodce zabezpečením PostgreSQL
- [Vzory databází pro multi-tenancy](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Architektonické vzory

### Testování zabezpečení
- [OWASP Testing Guide](https://owasp.org/www-project-web-security-testing-guide/) - Komplexní testování zabezpečení
- [Nejlepší postupy zabezpečení JWT](https://tools.ietf.org/html/rfc8725) - Doporučení pro zabezpečení JWT
- [Testování zabezpečení API](https://owasp.org/www-project-api-security/) - Testování specifické pro API

---

**Předchozí**: [Lab 01: Základní koncepty architektury](../01-Architecture/README.md)  
**Další**: [Lab 03: Nastavení prostředí](../03-Setup/README.md)
