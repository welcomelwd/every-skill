# الأمن وتعدد المستأجرين

## 🎯 ما يغطيه هذا المختبر

يوفر هذا المختبر إرشادات شاملة حول تنفيذ الأمن على مستوى المؤسسات وتعدد المستأجرين لخوادم MCP. ستتعلم كيفية تصميم أنظمة آمنة ومتوافقة تحمي البيانات الحساسة في قطاع التجزئة مع تمكين أنماط الوصول المرنة عبر مستأجرين متعددين.

## نظرة عامة

الأمن هو عنصر أساسي في تطبيقات التجزئة التي تتعامل مع بيانات العملاء، معلومات الدفع، وذكاء الأعمال. يغطي هذا المختبر الهيكل الأمني الكامل بدءًا من المصادقة والتفويض إلى عزل البيانات ومراقبة الامتثال.

نقوم بتنفيذ استراتيجية دفاعية متعددة الطبقات تجمع بين خدمات الهوية في Azure، أمان الصفوف في PostgreSQL، ضوابط على مستوى التطبيق، وتسجيل شامل للتدقيق لإنشاء منصة قوية ومتوافقة.

## أهداف التعلم

بنهاية هذا المختبر، ستكون قادرًا على:

- **تنفيذ** أمان الصفوف على مستوى المؤسسات لعزل بيانات المستأجرين
- **تصميم** أنماط مصادقة وتفويض آمنة باستخدام Azure
- **تكوين** تسجيل تدقيق شامل لتلبية متطلبات الامتثال
- **تطبيق** استراتيجيات أمنية متعددة الطبقات عبر جميع طبقات التطبيق
- **التحقق** من تنفيذ الأمن من خلال اختبارات منهجية
- **مراقبة** الأحداث الأمنية والاستجابة للتهديدات المحتملة

## 🔐 هيكل الأمن لتعدد المستأجرين

### نظرة عامة على طبقات الأمن
...
نستخدم في تنفيذنا نموذج **قاعدة بيانات مشتركة، مخطط مشترك** مع أمان الصفوف:

**الفوائد:**
- استخدام فعال للموارد بتكلفة منخفضة
- تبسيط الصيانة والتحديثات
- عزل قوي للبيانات من خلال RLS
- مسارات تدقيق متوافقة مع الامتثال

**المقايضات:**
- يتطلب تصميم سياسات RLS بعناية
- تغييرات المخطط تؤثر على جميع المستأجرين
- الحاجة إلى إجراءات نسخ احتياطي واستعادة قوية
...
✅ **أمن تعدد المستأجرين**: نفذت أمان الصفوف لعزل البيانات بالكامل  
✅ **مصادقة Azure**: دمجت Azure Entra ID مع التحقق من JWT  
✅ **تفويض قائم على الأدوار**: قمت بتكوين نظام أدوار وصلاحيات هرمي  
✅ **تسجيل تدقيق شامل**: أنشأت تتبع ومراقبة للأحداث الأمنية  
✅ **اختبار الأمن**: نفذت اختبارات تحقق أمنية آلية  
✅ **مراقبة التهديدات**: أنشأت كشف وتنبيه للأحداث الأمنية في الوقت الحقيقي  

## 🚀 ما التالي

تابع مع **[مختبر 03: إعداد البيئة](../03-Setup/README.md)** لـ:

- تكوين بيئات التطوير مع أفضل ممارسات الأمن
- إعداد خدمات Azure للمصادقة والمراقبة
- تنفيذ اتصالات قاعدة بيانات آمنة وإدارة الأسرار
- التحقق من تكوينات الأمن في بيئات التطوير

## 📚 موارد إضافية

### أمن Azure
- [وثائق Azure Entra ID](https://docs.microsoft.com/azure/active-directory/) - دليل منصة الهوية الكامل
- [Azure Key Vault](https://docs.microsoft.com/azure/key-vault/) - خدمة إدارة الأسرار
- [أفضل ممارسات أمن Azure](https://docs.microsoft.com/azure/security/fundamentals/best-practices-and-patterns) - إرشادات الأمن

### أمن قواعد البيانات
- [أمان الصفوف في PostgreSQL](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - وثائق RLS الرسمية
- [قائمة التحقق لأمن قواعد البيانات](https://www.postgresql.org/docs/current/security.html) - دليل أمن PostgreSQL
- [أنماط قواعد البيانات متعددة المستأجرين](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - أنماط الهيكل

### اختبار الأمن
- [دليل اختبار OWASP](https://owasp.org/www-project-web-security-testing-guide/) - اختبار الأمن الشامل
- [أفضل ممارسات أمن JWT](https://tools.ietf.org/html/rfc8725) - اعتبارات أمن JWT
- [اختبار أمن API](https://owasp.org/www-project-api-security/) - اختبار أمن خاص بـ API

---

**السابق**: [مختبر 01: مفاهيم الهيكل الأساسية](../01-Architecture/README.md)  
**التالي**: [مختبر 03: إعداد البيئة](../03-Setup/README.md)
