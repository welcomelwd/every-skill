...
يوفر هذا المختبر إرشادات شاملة لتنفيذ المراقبة، وقابلية الملاحظة، والتنبيهات لخادم MCP في بيئات الإنتاج. ستتعلم كيفية إعداد Application Insights، إنشاء لوحات معلومات ذات مغزى، تنفيذ تنبيهات فعالة، ووضع تدفقات عمل لحل المشكلات لتحقيق التميز التشغيلي.

## نظرة عامة

تعتبر المراقبة وقابلية الملاحظة الفعالة أمرًا بالغ الأهمية للحفاظ على خوادم MCP موثوقة في بيئات الإنتاج. يغطي هذا المختبر الركائز الثلاث لقابلية الملاحظة—المقاييس، السجلات، والتتبع—ويُظهر لك كيفية تنفيذ مراقبة شاملة تُمكّنك من اكتشاف المشكلات بشكل استباقي وحلها بسرعة.

ستتعلم كيفية تحويل بيانات القياس الأولية إلى رؤى قابلة للتنفيذ تساعدك على فهم سلوك النظام، تحسين الأداء، وضمان التوافر العالي.

## أهداف التعلم

بنهاية هذا المختبر، ستكون قادرًا على:

- **تنفيذ** تكامل شامل لـ Application Insights لخوادم MCP  
- **تصميم** أنماط تسجيل منظمة لتسهيل حل المشكلات  
- **إنشاء** أنظمة لجمع وتحليل مقاييس الأداء  
- **تكوين** تنبيهات ذكية مع إشعارات قابلة للتنفيذ  
- **بناء** لوحات معلومات تشغيلية للمراقبة في الوقت الفعلي  
- **إنشاء** تدفقات عمل فعالة لحل المشكلات ودليل تشغيل  
...
### تحسين التسجيل باستخدام البيانات المنظمة
...
✅ **تكامل Application Insights**: إعداد كامل للقياس والمراقبة  
✅ **تسجيل منظم**: تسجيل جاهز للإنتاج مع الربط والسياق  
✅ **مقاييس مخصصة**: جمع وتحليل مقاييس الأعمال والتقنية  
✅ **تنبيهات ذكية**: تنبيهات استباقية مع قنوات إشعار متعددة  
✅ **لوحات معلومات تشغيلية**: مراقبة في الوقت الفعلي ورؤى الأعمال  
✅ **تدفقات عمل لحل المشكلات**: تشخيص تلقائي ودليل تشغيل تشغيلي  

## 🚀 ما التالي

تابع مع **[مختبر 12: أفضل الممارسات والتحسين](../12-Best-Practices/README.md)** لتتعلم:

- تطبيق تقنيات تحسين الأداء  
- تنفيذ تعزيز شامل للأمان  
- تعلم أفضل الممارسات لنشر الإنتاج  
- وضع استراتيجيات تحسين التكلفة  

## 📚 موارد إضافية

### Azure Monitor
- [وثائق Application Insights](https://docs.microsoft.com/azure/azure-monitor/app/app-insights-overview) - دليل المراقبة الكامل  
- [مرجع استعلام KQL](https://docs.microsoft.com/azure/data-explorer/kql-quick-reference) - لغة الاستعلام لـ Application Insights  
- [دفاتر عمل Azure Monitor](https://docs.microsoft.com/azure/azure-monitor/visualize/workbooks-overview) - إنشاء لوحات معلومات مخصصة  

### OpenTelemetry
- [OpenTelemetry Python](https://opentelemetry.io/docs/instrumentation/python/) - دليل الأدوات  
- [التتبع الموزع](https://opentelemetry.io/docs/concepts/observability-primer/#distributed-traces) - مفاهيم التتبع  
- [جمع المقاييس](https://opentelemetry.io/docs/concepts/observability-primer/#reliability--metrics) - أفضل الممارسات للمقاييس  

### التميز التشغيلي
- [دليل SRE](https://sre.google/sre-book/table-of-contents/) - مبادئ هندسة موثوقية المواقع  
- [أفضل ممارسات المراقبة](https://cloud.google.com/architecture/framework/reliability/monitoring-alerting-logging) - أفضل الممارسات في الصناعة  
- [إدارة الحوادث](https://response.pagerduty.com/) - دليل إدارة الحوادث  

---

**السابق**: [مختبر 10: استراتيجيات النشر](../10-Deployment/README.md)  
**التالي**: [مختبر 12: أفضل الممارسات والتحسين](../12-Best-Practices/README.md)  
