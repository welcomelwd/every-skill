...
يوفر هذا المختبر إرشادات شاملة لنشر خادم MCP الخاص بالتجزئة في بيئات الإنتاج باستخدام أساليب الحاويات الحديثة ونهج السحابة الأصلية. ستتعلم كيفية نشر خوادم MCP قابلة للتوسع وآمنة ومراقبة يمكنها التعامل مع أعباء العمل المؤسسية.

## نظرة عامة

يتطلب نشر خوادم MCP في بيئة الإنتاج مراعاة دقيقة للحاويات، والتنسيق، والأمان، وقابلية التوسع، والمراقبة. يغطي هذا المختبر النشر على Azure Container Apps مع PostgreSQL Flexible Server، وتنفيذ خطوط CI/CD، وتكوين التوسع التلقائي لأعباء العمل المتغيرة.

تتراوح استراتيجيات النشر من عمليات نشر بسيطة لحاوية واحدة للتطوير إلى بيئات إنتاج متعددة المناطق مع التوسع التلقائي وميزات المراقبة والأمان الشاملة.

## أهداف التعلم

بنهاية هذا المختبر، ستكون قادرًا على:

- **تحويل إلى حاويات** خوادم MCP باستخدام Docker مع بناء متعدد المراحل  
- **النشر** على Azure Container Apps مع شبكات آمنة  
- **تكوين** PostgreSQL بدرجة إنتاجية مع توفر عالي  
- **تنفيذ** خطوط CI/CD للنشر الآلي  
- **توسيع** التطبيقات تلقائيًا بناءً على الطلب  
- **مراقبة** عمليات النشر الإنتاجية باستخدام أدوات المراقبة الشاملة  

## 🐳 تحويل إلى حاويات باستخدام Docker

### ملف Docker متعدد المراحل
...
## ☁️ نشر على Azure Container Apps
...
✅ **استراتيجية الحاويات**: حاويات Docker جاهزة للإنتاج مع تعزيز الأمان  
✅ **النشر السحابي**: Azure Container Apps مع التوسع التلقائي والمراقبة  
✅ **نشر قاعدة البيانات**: PostgreSQL Flexible Server مع توفر عالي  
✅ **خطوط CI/CD**: اختبارات آلية، وبناء، وعمليات نشر  
✅ **مراقبة الأداء**: جمع شامل للبيانات وإنشاء تنبيهات  
✅ **تكوين الأمان**: سياسات أمان جاهزة للإنتاج وعزل الشبكات  

## 🚀 ما التالي

تابع مع **[مختبر 11: المراقبة وقابلية الملاحظة](../11-Monitoring/README.md)** لتتعلم:

- إعداد مراقبة شاملة باستخدام Application Insights  
- تكوين تسجيل منظم وتتبع موزع  
- تنفيذ أنظمة التنبيه والاستجابة الآلية  
- مراقبة مؤشرات الأداء الرئيسية للأعمال  

## 📚 موارد إضافية

### تقنيات الحاويات
- [أفضل ممارسات Docker](https://docs.docker.com/develop/dev-best-practices/) - أفضل ممارسات Docker الرسمية  
- [Azure Container Apps](https://docs.microsoft.com/en-us/azure/container-apps/) - وثائق Azure Container Apps  
- [وثائق Kubernetes](https://kubernetes.io/docs/) - وثائق Kubernetes الرسمية  

### CI/CD و DevOps
- [GitHub Actions](https://docs.github.com/en/actions) - وثائق GitHub Actions  
- [Azure DevOps](https://docs.microsoft.com/en-us/azure/devops/) - خدمات Azure DevOps  
- [البنية التحتية ككود](https://docs.microsoft.com/en-us/azure/azure-resource-manager/bicep/) - وثائق Azure Bicep  

### الأمان والمراقبة
- [Azure Security Center](https://docs.microsoft.com/en-us/azure/security-center/) - توصيات الأمان من Azure  
- [أمان الحاويات](https://kubernetes.io/docs/concepts/security/) - مفاهيم أمان Kubernetes  
- [Application Insights](https://docs.microsoft.com/en-us/azure/azure-monitor/app/app-insights-overview) - نظرة عامة على Azure Application Insights  

---

**السابق**: [مختبر 09: تكامل VS Code](../09-VS-Code/README.md)  
**التالي**: [مختبر 11: المراقبة وقابلية الملاحظة](../11-Monitoring/README.md)  
