...
تزداد أهمية التطبيقات متعددة الوسائط في مجال الذكاء الاصطناعي، حيث تتيح تفاعلات أغنى ومهام أكثر تعقيدًا. يوفر بروتوكول سياق النموذج (MCP) إطارًا لبناء تطبيقات متعددة الوسائط يمكنها التعامل مع أنواع مختلفة من البيانات، مثل النصوص، الصور، والصوت.

يدعم MCP ليس فقط التفاعلات النصية، بل أيضًا القدرات متعددة الوسائط، مما يسمح للنماذج بالعمل مع الصور، الصوت، وأنواع بيانات أخرى.

## المقدمة

في هذا الدرس، ستتعلم كيفية بناء تطبيق متعدد الوسائط.

## أهداف التعلم

بنهاية هذا الدرس، ستكون قادرًا على:

- فهم الخيارات متعددة الوسائط  
- تنفيذ تطبيق متعدد الوسائط.

## البنية الداعمة لتعدد الوسائط

عادةً ما تتضمن تطبيقات MCP متعددة الوسائط ما يلي:

- **محللات خاصة بكل وسيلة**: مكونات تحول أنواع الوسائط المختلفة إلى صيغ يمكن للنموذج معالجتها.  
- **أدوات خاصة بكل وسيلة**: أدوات مخصصة لمعالجة وسائط معينة (تحليل الصور، معالجة الصوت)  
- **إدارة سياق موحدة**: نظام للحفاظ على السياق عبر الوسائط المختلفة  
- **توليد الاستجابات**: القدرة على إنشاء استجابات قد تشمل وسائط متعددة.

## مثال متعدد الوسائط: تحليل الصور

في المثال أدناه، سنقوم بتحليل صورة واستخلاص المعلومات منها.
...
في المثال السابق، قمنا بـ:

- إنشاء `ImageAnalysisTool` يمكنه تحليل الصور باستخدام خدمة افتراضية `IImageAnalysisService`.  
- تكوين خادم MCP للتعامل مع طلبات أكبر ودعم أنواع محتوى الصور.  
- تسجيل أداة تحليل الصور مع الخادم.  
- تنفيذ طريقة لتحميل الصور من عنوان URL وتحليلها بناءً على النوع المطلوب (الأجسام، النصوص، الوجوه، إلخ).  
- إرجاع نتائج منظمة بصيغة متوافقة مع مواصفات MCP.

## مثال متعدد الوسائط: معالجة الصوت

تعد معالجة الصوت وسيلة شائعة أخرى في التطبيقات متعددة الوسائط. فيما يلي مثال على كيفية تنفيذ أداة نسخ صوتي يمكنها التعامل مع ملفات الصوت وإرجاع النصوص.
...
- إنشاء `AudioTranscriptionTool` يمكنه نسخ ملفات الصوت.  
- تحديد مخطط الأداة لقبول إما عنوان URL أو بيانات صوتية مشفرة بصيغة base64.  
- تنفيذ طريقة `execute` لمعالجة الصوت والنسخ.  
- تكوين خادم MCP للتعامل مع الطلبات متعددة الوسائط، بما في ذلك معالجة الصوت والصورة.  
- تسجيل أداة النسخ الصوتي مع الخادم.  
- تنفيذ طريقة لتحميل ملفات الصوت من عنوان URL أو فك ترميز بيانات الصوت بصيغة base64.  
- استخدام خدمة `AudioProcessor` لمعالجة منطق النسخ الفعلي.  
- بدء تشغيل خادم MCP للاستماع للطلبات.
